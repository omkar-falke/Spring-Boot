...
select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cisqt,0) <>isnull(yr_cisqt,0) and stp_cmpcd = '01' and stp_strtp in('01','06','07','08') and yr_cmpcd = '01' and yr_strtp in('01','06','07','08') and stp_cmpcd=yr_cmpcd and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_crcqt,0) <>isnull(yr_crcqt,0) and stp_cmpcd = '01' and stp_strtp in('01','06','07','08') and yr_cmpcd = '01' and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_csaqt,0) <>isnull(yr_csaqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cstqt,0) <>isnull(yr_cstqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cmrqt,0) <>isnull(yr_cmrqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_ycsqt,0) <>isnull(yr_ycsqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_yclrt,0) <>isnull(yr_yclrt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

/* checking for difference of cum . value */

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_crcvl,0) <>isnull(yr_crcvl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cisvl,0) <>isnull(yr_cisvl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cmrvl,0) <>isnull(yr_cmrvl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_csavl,0) <>isnull(yr_csavl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select * from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_csavl,0) <>isnull(yr_csavl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_ycsvl,0) <>isnull(yr_ycsvl,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select count(*) from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_yclrt,0) <>isnull(yr_yclrt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

/* checking for difference of cum . quantity */

select YR_STRTP,yr_matcd,yr_crcqt,stp_crcqt from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_crcqt,0) <>isnull(yr_crcqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select YR_STRTP,yr_matcd,yr_cisqt,stp_cisqt from spldata.mm_yrprc,spldata.mm_stprc where isnull(stp_cisqt,0) <>isnull(yr_cisqt,0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select stp_matcd,stp_crcvl,yr_crcvl from spldata.mm_yrprc,spldata.mm_stprc where round(isnull(stp_crcvl,0),0) <>round(isnull(yr_crcvl,0),0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;

select stp_matcd,stp_csavl,yr_csavl from spldata.mm_yrprc,spldata.mm_stprc where round(isnull(stp_csavl,0),0) <>round(isnull(yr_csavl,0),0) and stp_strtp in('01','06','07','08') and yr_strtp in('01','06','07','08') and stp_strtp = yr_strtp and stp_matcd = yr_matcd ;
...
UPDATE SPLDATA.MM_STPRC a SET STP_YCMQT=(SELECT isnull(YR_YCMQT ,0) FROM SPLDATA.MM_YRPRC WHERE YR_CMPCD = '01' and YR_CMPCD=a.STP_CMPCD  AND YR_STRTP=a.STP_STRTP AND YR_MATCD=a.STP_MATCD) WHERE a.stp_cmpcd = '01' and a.STP_STRTP NOT IN ('04','09','41','42','43') AND a.STP_CMPCD + a.STP_STRTP + a.STP_MATCD IN (SELECT B.YR_CMPCD + B.YR_STRTP + B.YR_MATCD FROM SPLDATA.MM_YRPRC B);

UPDATE SPLDATA.MM_STPRC a SET STP_YCMVL=(SELECT isnull(YR_YCMVL ,0) FROM SPLDATA.MM_YRPRC WHERE YR_CMPCD = '01' and YR_CMPCD = a.STP_CMPCD and YR_STRTP=a.STP_STRTP AND YR_MATCD=a.STP_MATCD) WHERE a.stp_cmpcd = '01' and a.STP_STRTP NOT IN ('04','09','41','42','43') AND a.STP_CMPCD + a.STP_STRTP + a.STP_MATCD IN (SELECT B.YR_CMPCD + B.YR_STRTP + B.YR_MATCD FROM SPLDATA.MM_YRPRC B);
...
SELECT STP_MATCD,STP_MATDS,STP_UOMCD,STP_MOSQT,STP_MCSQT, (isnull(STP_MCRCQ,0) - isnull(STP_MORCQ,0)) RECQT, (isnull(STP_MCMRQ,0) - isnull(STP_MOMRQ,0)) MRNQT,(isnull(STP_MCISQ,0) - isnull(STP_MOISQ,0)) ISSQT, (isnull(STP_MCSAQ,0) - isnull(STP_MOSAQ,0)) SANQT, (isnull(stp_mosqt,0)+(isnull(STP_MCRCQ,0) - isnull(STP_MORCQ,0))+(isnull(STP_MCMRQ,0) - isnull(STP_MOMRQ,0))-(isnull(STP_MCISQ,0) - isnull(STP_MOISQ,0))+(isnull(STP_MCSAQ,0) - isnull(STP_MOSAQ,0))) STP_MCSQT1  FROM spldata.MM_STPRC WHERE STP_STRTP = '08'  AND  (isnull(stp_mosqt,0)+(isnull(STP_MCRCQ,0) - isnull(STP_MORCQ,0))+(isnull(STP_MCMRQ,0) - isnull(STP_MOMRQ,0))-(isnull(STP_MCISQ,0) - isnull(STP_MOISQ,0))+(isnull(STP_MCSAQ,0) - isnull(STP_MOSAQ,0))) <> isnull(STP_MCSQT,0)  ORDER BY STP_MATCD;
...
select  GR_STRTP, sum(GR_ACPQT) from spldata.MM_GRMST where GR_CMPCD = '01' and  GR_ACPDT between '12/01/2009' and '12/31/2009' and GR_STSFL='2'  and isnull(GR_ACPQT,0) >0  and gr_strtp in ('01','06','07','08','04') and substr(gr_matcd,1,2) not in ('85','86') group by GR_STRTP;
...
;
select  IS_STRTP, sum(IS_ISSQT) from spldata.MM_ISMST where IS_CMPCD = '01'  and CONVERT(varchar,IS_AUTDT,101) between '12/01/2009' and '12/31/2009'  and IS_STSFL='2' and isnull(IS_ISSQT,0) >0 and is_strtp in ('01','06','07','08','04') group by IS_STRTP;
