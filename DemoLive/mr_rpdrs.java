...
Program Name		: Grade Wise D.O. status
Author				: AAP
...
class mr_rpdrs extends cl_rbase
{
	...
	private	Hashtable<String,float[]>	L_hstINDAY_RG=new Hashtable<String,float[]>(20,0.75f),
					L_hstINMTH_RG=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVDAY_RG=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVMTH_RG=new Hashtable<String,float[]>(20,0.75f);
	private	Hashtable<String,float[]> L_hstINDAY_AI=new Hashtable<String,float[]>(20,0.75f),
					L_hstINMTH_AI=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVDAY_AI=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVMTH_AI=new Hashtable<String,float[]>(20,0.75f);
	private	Hashtable<String,float[]> L_hstINDAY_XP=new Hashtable<String,float[]>(20,0.75f),
					L_hstINMTH_XP=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVDAY_XP=new Hashtable<String,float[]>(20,0.75f),
					L_hstIVMTH_XP=new Hashtable<String,float[]>(20,0.75f);
	 ...
	 mr_rpdrs()
	{
		...
		try
		{
			...
			M_rstRSSET=cl_dat.exeSQLQRY0("Select SUBSTRING(CMT_CODCD,1,4) CMT_CODCD,CMT_SHRDS,CMT_CHP01 from CO_CDTRN where CMT_CGMTP='MST' and CMT_CGSTP='COXXPGR' order by CMT_CODCD");
			if(M_rstRSSET!=null)
			{
	...
	void exePRINT()
	{
		...
		L_hstINDAY_RG=new Hashtable<String,float[]>(20,0.75f);
		L_hstINMTH_RG=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVDAY_RG=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVMTH_RG=new Hashtable<String,float[]>(20,0.75f);

		L_hstINDAY_AI=new Hashtable<String,float[]>(20,0.75f);
		L_hstINMTH_AI=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVDAY_AI=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVMTH_AI=new Hashtable<String,float[]>(20,0.75f);

		L_hstINDAY_XP=new Hashtable<String,float[]>(20,0.75f);
		L_hstINMTH_XP=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVDAY_XP=new Hashtable<String,float[]>(20,0.75f);
		L_hstIVMTH_XP=new Hashtable<String,float[]>(20,0.75f);
		...
		try
		{
			...
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(INT_INDQT) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST,CO_CDTRN where IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN,VW_INTRN,CO_CDTRN where dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_DORDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL not in ('X','0') and DOT_SBSCD1 in "+M_strSBSLS+"  and dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP  not in ('04','05','12','16','21') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINDAY!=null)
			{
				while(L_rstINDAY.next())
					L_hstINDAY_RG.put(L_rstINDAY.getString("CMT_CHP02")+"|"+L_rstINDAY.getString("IN_SALTP")+"|"+L_rstINDAY.getString("PRDCD"),new float[]{L_rstINDAY.getFloat("DORQT"),L_rstINDAY.getFloat("RSNVL")});
				L_rstINDAY.close();
			}

			//M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(INT_INDQT) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST where IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN,VW_INTRN where dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_SBSCD1 in "+M_strSBSLS+" and DOT_DORDT ='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL not in ('X','0') and dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP not in ('04','05','12','16','21')   group by DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINDAY!=null)
			{
				while(L_rstINDAY.next())
					L_hstINDAY_AI.put(L_rstINDAY.getString("IN_SALTP")+"|"+L_rstINDAY.getString("PRDCD"),new float[]{L_rstINDAY.getFloat("DORQT"),L_rstINDAY.getFloat("RSNVL")});
				L_rstINDAY.close();
			}
			

			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(INT_INDQT) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST where IN_SALTP = '12' and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN,VW_INTRN where dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_SBSCD1 in "+M_strSBSLS+" and dot_cmpcd = int_cmpcd and DOT_MKTTP = INT_MKTTP and DOT_INDNO = INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and  IN_SALTP = '12' and DOT_DORDT ='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL not in ('X','0') group by DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4) order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINDAY!=null)
			{
				while(L_rstINDAY.next())
					L_hstINDAY_XP.put(L_rstINDAY.getString("PRDCD"),new float[]{L_rstINDAY.getFloat("DORQT"),L_rstINDAY.getFloat("RSNVL")});
				L_rstINDAY.close();
			}
			
			
			//System.out.println("002");
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(INT_INDQT) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST,CO_CDTRN  where IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL <>'X' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN,VW_INTRN,CO_CDTRN  where dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_SBSCD1 in "+M_strSBSLS+" and DOT_DORDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL <>'X'  and dot_cmpcd = int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO = INT_INDNO and DOT_PRDCD = INT_PRDCD and  DOT_PKGTP = INT_PKGTP and IN_SALTP  not in ('04','05','12','16','21') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINMTH!=null)
			{
				while(L_rstINMTH.next())
					L_hstINMTH_RG.put(L_rstINMTH.getString("CMT_CHP02")+"|"+L_rstINMTH.getString("IN_SALTP")+"|"+L_rstINMTH.getString("PRDCD"),new float[]{L_rstINMTH.getFloat("DORQT"),L_rstINMTH.getFloat("RSNVL")});
				L_rstINMTH.close();
			}


			//M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(INT_INDQT) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST  where IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL <>'X'  group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN, VW_INTRN  where  dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_DORDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL <>'X' and DOT_SBSCD1 in "+M_strSBSLS+" and dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP  not in ('04','05','12','16','21') group by DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINMTH!=null)
			{
				while(L_rstINMTH.next())
					L_hstINMTH_AI.put(L_rstINMTH.getString("IN_SALTP")+"|"+L_rstINMTH.getString("PRDCD"),new float[]{L_rstINMTH.getFloat("DORQT"),L_rstINMTH.getFloat("RSNVL")});
				L_rstINMTH.close();
			}
			

			M_strSQLQRY="Select DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(DOT_DORQT) DORQT,sum(DOT_RSNVL) RSNVL from MR_DOTRN, VW_INTRN  where  dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_DORDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and DOT_STSFL <>'X' and dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP  and DOT_SBSCD1 in "+M_strSBSLS+" and IN_SALTP = '12' group by DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4) order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINMTH!=null)
			{
				while(L_rstINMTH.next())
					L_hstINMTH_XP.put(L_rstINMTH.getString("PRDCD"),new float[]{L_rstINMTH.getFloat("DORQT"),L_rstINMTH.getFloat("RSNVL")});
				L_rstINMTH.close();
			}
			...
			M_strSQLQRY="Select DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(isnull(DOT_CFWQT,0)) CRFQT,sum((isnull(DOT_RSNVL,0)/isnull(DOT_DORQT,0))*isnull(DOT_CFWQT,0)) RSNVL ,DOT_DORQT from MR_DOTRN,VW_INTRN,CO_CDTRN  where  dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_DORDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"'  and DOT_STSFL <>'X' and isnull(DOT_CFWQT,0)>0 and DOT_SBSCD1 in "+M_strSBSLS+" and  dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP  not in ('04','05','12','16','21') and  CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by DOT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4),DOT_DORQT order by CMT_CHP02,SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			...
			M_strSQLQRY="Select DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(isnull(DOT_CFWQT,0)) CRFQT,sum((isnull(DOT_RSNVL,0)/isnull(DOT_DORQT,0))*isnull(DOT_CFWQT,0)) RSNVL ,DOT_DORQT from MR_DOTRN, VW_INTRN  where dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_DORDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and DOT_STSFL <>'X' and isnull(DOT_CFWQT,0)>0 and DOT_SBSCD1 in "+M_strSBSLS+" and dot_cmpcd=int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP  not in ('04','05','12','16','21')   group by DOT_MKTTP,IN_SALTP,SUBSTRING(DOT_PRDCD,1,4),DOT_DORQT order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			...
			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/isnull(INT_INDQT,0))*isnull(INT_CFWQT,0)) RSNVL ,INT_INDQT from MR_INTRN,MR_INMST  where  IN_SALTP = '12' and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_STSFL <>'X' and isnull(INT_CFWQT,0)>0 group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4) PRDCD,sum(isnull(DOT_CFWQT,0)) CRFQT,sum((isnull(DOT_RSNVL,0)/isnull(DOT_DORQT,0))*isnull(DOT_CFWQT,0)) RSNVL ,DOT_DORQT from MR_DOTRN, VW_INTRN  where  dot_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and DOT_SBSCD1 in "+M_strSBSLS+" and DOT_DORDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and DOT_STSFL <>'X' and isnull(DOT_CFWQT,0)>0 and dot_cmpcd = int_cmpcd and DOT_MKTTP=INT_MKTTP and DOT_INDNO=INT_INDNO and DOT_PRDCD = INT_PRDCD and DOT_PKGTP = INT_PKGTP and IN_SALTP = '12' group by DOT_MKTTP,SUBSTRING(DOT_PRDCD,1,4),DOT_DORQT order by SUBSTRING(DOT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			...
			M_strSQLQRY="Select IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN,CO_CDTRN  where ivt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD1 in "+M_strSBSLS+" and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IVT_ZONCD group by IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(IVT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			...
			M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD1 in "+M_strSBSLS+" and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstIVDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVDAY!=null)
			{
			...
			M_strSQLQRY="Select IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where  ivt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and IVT_SALTP = '12' and IVT_SBSCD1 in "+M_strSBSLS+" and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' group by IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstIVDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVDAY!=null)
			{
			...
			M_strSQLQRY="Select IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN,CO_CDTRN  where ivt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD1 in "+M_strSBSLS+" and CONVERT(varchar,IVT_INVDT,101) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IVT_ZONCD group by IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(IVT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			...
			M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where ivt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD1 in "+M_strSBSLS+" and CONVERT(varchar,IVT_INVDT,101) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D' group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstIVMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVMTH!=null)
			{
			...
			File L_filREPORT=new File(cl_dat.M_strREPSTR_pbst+"mr_rpdrs."+(M_rdbTEXT.isSelected() ? "doc" : "htm"));
			FileOutputStream L_fosREPORT=new FileOutputStream(L_filREPORT);
			dosREPORT=new DataOutputStream(L_fosREPORT);
			//System.out.println("file created "+cl_dat.M_strREPSTR_pbst+"mr_rpdrs."+(M_rdbTEXT.isSelected() ? "doc" : "htm"));
			...
			{//DISPLAY HTML REPORT IN BROWSER
					...
					String L_strDOCFIL = cl_dat.M_strREPSTR_pbst+"mr_rpdrs.doc";
					if(M_rdbHTML.isSelected())
					{
						L_strDOCEXE = "c:\\program files\\internet explorer\\iexplore.exe";
						L_strDOCFIL = cl_dat.M_strREPSTR_pbst+"mr_rpdrs.htm";
					}
		...
		//PRINT TO PRINTER IN PRINT OPTION IN TEXT FORMAT
				...
				doPRINT(cl_dat.M_strREPSTR_pbst+"mr_rpdrs.doc");
			...
			//E_MAIL THE RESPECTIVE FILE TO RECEIPENTS, ONE BY ONE
				for(int i=0;i<M_cmbDESTN.getItemCount();i++)
					((cl_eml)Class.forName("cl_eml").newInstance()).sendfile(M_cmbDESTN.getItemAt(i).toString(),cl_dat.M_strREPSTR_pbst+"mr_rpdrs."+(M_rdbTEXT.isSelected() ? "doc" : "htm"),"Net Sales Realisation for the period from "+M_txtFMDAT.getText()+" to "+M_txtTODAT.getText(),"");
	...
	{
		float L_fltDORQT=0,L_fltINDVL=0,L_fltINMQT=0,L_fltINMVL=0,L_fltIVDQT=0,L_fltIVDVL=0,L_fltIVMQT=0,L_fltIVMVL=0;
...
//					System.out.println(setNumberFormat(L_flaTEMP[0],3)+" "+setNumberFormat(L_flaTEMP[1],3)+" "+setNumberFormat(L_flaTEMP[1]/L_flaTEMP[0],3));
		...
		if(L_fltDORQT>0||L_fltINDVL>0||L_fltINMQT>0||L_fltINMVL>0||L_fltIVDQT>0||L_fltIVDVL>0||L_fltIVMQT>0||L_fltIVMVL>0)
			return new float[]{L_fltDORQT,L_fltINDVL,L_fltIVDQT,L_fltIVDVL,L_fltINMQT,L_fltINMVL,L_fltIVMQT,L_fltIVMVL};
		else
			return null;
	...
	private void prnHEADR() throws Exception
	{
		...
		dosREPORT.writeBytes(padSTRING('L',"D.O. (Day)",13));
		dosREPORT.writeBytes(padSTRING('L',"N.D.R. (Day)",13));
		dosREPORT.writeBytes(padSTRING('L',"Dispatch (Day)",13));
		dosREPORT.writeBytes(padSTRING('L',"N.S.R. (Day)",13));
		dosREPORT.writeBytes(padSTRING('L',"D.O.(Month)",13));
		dosREPORT.writeBytes(padSTRING('L',"N.D.R. (Month)",13));
