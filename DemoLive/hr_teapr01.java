...
class hr_teapr01 extends JFrame implements ActionListener,Runnable
{
   	private File file;
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        hr_teapr01 ohr_teapr01 = new hr_teapr01();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        hr_teapr01_thrData thr1 = new hr_teapr01_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class hr_teapr01_thrData extends Thread
{
   // Hashtable hstData;
    String strDate="",M_strCMPCD="01";
    ...
    hr_teapr01_thrData(String strDate,Connection P_conSPDBA)
    {
