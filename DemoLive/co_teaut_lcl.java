...
private void exeLOTRCL()
{
	try
	{
    	...
    	strRCLDOC = cl_dat.getPRMCOD("CMT_CCSVL","DOC","QCXXGCH",L_strCODCD);
    	...
    	M_strSQLQRY +=" WHERE CMT_CGMTP ='DOC' and CMT_CGSTP ='QCXXGCH' and CMT_CODCD ='"+L_strCODCD.trim()+"'";
    	cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
    ...
    ///	M_strSQLQRY +="' ',' ',"; // TDS Flag , package category
	    M_strSQLQRY +="' ',ST_PKGCT,"; // TDS Flag , package category
    ...
    ///	M_strSQLQRY +="' ',' ',' ',";				// Shift code,package cat.,PTFRF
    	M_strSQLQRY +="' ',ST_PKGCT,' ',";				// Shift code,package cat.,PTFRF
