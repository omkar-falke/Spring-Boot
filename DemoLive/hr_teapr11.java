...
class hr_teapr11 extends JFrame implements ActionListener,Runnable
{
   	private File file;
	...
	private static String M_strCMPCD ="11";
    hr_teapr11()
    {
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        hr_teapr11 ohr_teapr11 = new hr_teapr11();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        hr_teapr11_thrData thr1 = new hr_teapr11_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class hr_teapr11_thrData extends Thread
{
   // Hashtable hstData;
    String strDate="",M_strCMPCD="11";
    ...
    hr_teapr11_thrData(String strDate,Connection P_conSPDBA)
    {
