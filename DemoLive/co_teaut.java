...
class co_teaut extends cl_pbase implements ChangeListener, FocusListener
{
	private JTextField txtTEMP;
	private JButton btnRPDC1,btnRPDC2,btnRPDC3,btnRPVST,btnRPMRN;
	private JTabbedPane jtpTRNDT;
	private JPanel pnlGPAPR,pnlGPAUT,pnlINAUT,pnlCLSDT,pnlRCLDT,pnlPTFDT,pnlVSTGP,pnlMRAPR,pnlLVAUT;
	private cl_JTable tblGPAPR,tblGPAUT,tblINAUT,tblITDT1,tblITDT2,tblITDT3,tblVSTAUT,tblMRAPR,tblITDT4;
	...
	private final int TB6_CHKFL =0;
	private final int TB6_DSPFL =1;
	private final int TB6_STRTP =2;
	private final int TB6_MRNNO =3;
	private final int TB6_DPTCD =4;
	private final int TB6_APRVL =5;
	private final int TB6_APRFL =6;
	private final int TB6_REMDS =7;
	private final int TB6_PREBY =8;
	private final int TB6_VENCD =9;
	...
	private final String strVSTGP_fn ="Visitor Gate Pass";
	private final String strMRAPR_fn ="MRN Approval";
    ...
    private int intVSTGP = 99;
	private int intMRAPR = 99;
	private int intLVAUT = 99;
	
	private Hashtable<String,String> hstCODDS,hstCODCD,hstCMPVL,hstBAGVL,hstHSTST;
	...
	private JTextField txtLOTNO,txtRCLNO,txtBAGQT,txtREMDS,txtENDBY,txtPENDT,txtPCLBY,txtCLSBY;
	...
	private JLabel lblTSTBY,lblCLSBY,lblPCLBY,lblGRB,lblADDPAR,lblREFPAR,lblAUTCLS,lblPSTDT,lblPENDT,lblADDTM,lblENDTM,lblADDBY,lblENDBY;
    ...
    private Vector<String> vtrQPRCD = new Vector<String>();
    ...
    private Vector<String> LM_CMPFL = new Vector<String>();
	...
	private final int TB5_CHKFL =0;                          /** final value for Visitor tables Column */
	private final int TB5_DSPFL =1;
	private final int TB5_VSTNM =2;
	private final int TB5_VSORG =3;
	private final int TB5_VSTCT =4;
	private final int TB5_PERVS =5;
	private final int TB5_PURPS =6;
	private final int TB5_VSARA =7;
	private final int TB5_ARADS =8;
	private final int TB5_VSTDT =9;
	private final int TB5_VLDTM =10;
	private final int TB5_APRFL =11;
	private final int TB5_MOBFL =12;
	private final int TB5_CMRFL =13;
	private final int TB5_REMDS =14;
	private final int TB5_VSPNO =15;
	private final int TB5_VSCAT=16;
	private final int TB5_REQBY=17;
	...
	co_teaut()
	{
	   ...
	   try
	   {
		...
		String[] L_strTB4HD = {" ","Item Code ","UOM","Description","Ind.Qty.","Req.Date","Exp.Date","TC","Ins","Value"};
		int[] L_intCL4SZ = {20,120,120,300,120,100,100,20,20,100};
		...
		String[] L_strTB5HD = {"SEL","DSP","Str.Type ","MRN NO.","Dept.","Approx Value","<HTML> <P COLOUR = blue> Approval Flag </P></HTML>","Remark","Frw. by","Vendor" };
		int[] L_intCL5SZ = {25,30,100,100,100,72,120,200,100,100};
		
		tblMRAPR = crtTBLPNL1(pnlMRAPR,L_strTB5HD,100,1,1,5.2,5.9,L_intCL5SZ,new int[]{0,1});
		add(btnRPMRN=new JButton("Show Document"),7,5,1,1.5,pnlMRAPR,'L');
		tblITDT4 = crtTBLPNL1(pnlMRAPR,L_strTB4HD,100,8,1,8.3,5.9,L_intCL4SZ,new int[]{0,6});
		
		tblINAUT.setColumnColor(TBL_APRFL,java.awt.Color.blue);
		tblGPAPR.setColumnColor(TBL_APRFL,java.awt.Color.blue);
		tblMRAPR.setColumnColor(TB6_APRFL,java.awt.Color.blue);
	    ...
	    add(txtBAGQT = new TxtNumLimit(10.3),2,3,1,0.4,pnlCLSDT,'L');
	    add(txtIPRDS = new TxtLimit(20),2,3,1,0.6,pnlCLSDT,'R');
	    ...
	    add(txtTPRCD = new TxtLimit(10),4,1,1,1,pnlCLSDT,'L');
		add(txtPENDT = new TxtDate(),4,2,1,1,pnlCLSDT,'L');
		add(txtTPRDS = new TxtLimit(20),5,1,1,1.5,pnlCLSDT,'L');
		add(txtENDBY = new TxtLimit(5),5,2,1,0.5,pnlCLSDT,'R');
		
		add(txtPPRCD = new TxtLimit(10),4,3,1,1,pnlCLSDT,'L');
		add(txtPCLTM = new TxtTime(),4,4,1,1,pnlCLSDT,'L');
		add(txtPPRDS = new TxtLimit(20),5,3,1,1.5,pnlCLSDT,'L');
		add(txtPCLBY = new TxtLimit(5),5,4,1,0.5,pnlCLSDT,'R');
        
        add(txtCPRCD = new TxtLimit(10),4,5,1,1,pnlCLSDT,'L');
		add(txtCLSTM = new TxtTime(),4,6,1,1,pnlCLSDT,'L');
		add(txtCPRDS = new TxtLimit(20),5,5,1,1.5,pnlCLSDT,'L');
		add(txtCLSBY = new TxtLimit(5),5,6,1,0.5,pnlCLSDT,'R');
		...
		/*add(new JLabel("LOT"),14,2,1,1,pnlCLSDT,'L');
		add(new JLabel("OPEN"),14,3,1,1,pnlCLSDT,'L');
		add(new JLabel("CLOSE"),14,4,1,1,pnlCLSDT,'L');
		add(new JLabel("ACTUAL"),15,2,1,1,pnlCLSDT,'L');
		add(lblPSTDT = new JLabel(""),15,3,1,1,pnlCLSDT,'L');
		add(lblPENDT = new JLabel(""),15,4,1,1,pnlCLSDT,'L');
		add(new JLabel("ENTERED"),16,2,1,1,pnlCLSDT,'L');
		add(lblADDTM = new JLabel(""),16,3,1,1,pnlCLSDT,'L');
		add(lblENDTM = new JLabel(""),16,4,1,1,pnlCLSDT,'L');
		add(new JLabel("BY"),17,2,1,1,pnlCLSDT,'L');
		add(lblADDBY = new JLabel(""),17,3,1,1,pnlCLSDT,'L');
		add(lblENDBY = new JLabel(""),17,4,1,1,pnlCLSDT,'L');
		*/
		
		add(new JLabel("LOT"),14,1,1,1,pnlCLSDT,'L');
		add(new JLabel("ACTUAL"),14,2,1,1,pnlCLSDT,'L');
		add(new JLabel("ENTERED"),14,3,1,1,pnlCLSDT,'L');
		add(new JLabel("BY"),14,4,1,1,pnlCLSDT,'L');
		
		add(new JLabel("OPEN"),15,1,1,1,pnlCLSDT,'L');
		add(lblPSTDT = new JLabel(""),15,2,1,1,pnlCLSDT,'L');
		add(lblADDTM = new JLabel(""),15,3,1,1,pnlCLSDT,'L');
		add(lblADDBY = new JLabel(""),15,4,1,1,pnlCLSDT,'L');
		
		add(new JLabel("CLOSE"),16,1,1,1,pnlCLSDT,'L');
		add(lblPENDT = new JLabel(""),16,2,1,1,pnlCLSDT,'L');
		add(lblENDTM = new JLabel(""),16,3,1,1,pnlCLSDT,'L');
		add(lblENDBY = new JLabel(""),16,4,1,1,pnlCLSDT,'L');
...
/// Visitor GP Approval
		String[] L_strCOLHD = {"Select","DSP","Guest Name","Orgainsation","No.of Guests","To Visit","Purpose","Area","Area Desc","From Date","To Date","Apr. Flag","Mob. Allw","Cam.Allw","Remarks","Guest Pass No","Guest Category","REQ BY"};
		int[] L_intCOLSZ4 = {20,20,100,80,40,70,100,40,60,90,80,80,30,30,100,60,20,20};	  
		     tblVSTAUT = crtTBLPNL1(pnlVSTGP,L_strCOLHD,200,2,1,8,11.6,L_intCOLSZ4,new int[]{0,1,12,13});
///
		add(btnRPVST=new JButton("Show Document"),12,5,1,1.5,pnlVSTGP,'L');
       // Reclassification
        setMatrix(20,8);
		...
		M_strSQLQRY = "SELECT SUBSTRING(CMT_CODCD,5,10) L_CODCD FROM CO_CDTRN WHERE "
                    ...
                    + " AND CMT_CGMTP ='A"+cl_dat.M_strCMPCD_pbst+"' and CMT_CGSTP ='COXXAUT' ORDER BY CMT_NMP01";
		M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
		int L_intTABCT =0;
		String L_strCODCD;
		if(M_rstRSSET !=null)
		while(M_rstRSSET.next())
		{
		    ...
		    else if(L_strCODCD.equals("INAPR"))
		    {
				...
				jtpTRNDT.add(pnlINAUT,"Indent Auth");
		        intINAPR = L_intTABCT;
		    ...
		    else if(L_strCODCD.equals("VSTGP"))
		    {
		        jtpTRNDT.add(pnlVSTGP,strVSTGP_fn);
		        intVSTGP = L_intTABCT;
		        tblVSTAUT.addMouseListener(this);
		         L_intTABCT++;
		    }
			else if(L_strCODCD.equals("MRAPR"))
		    {
		        //jtpTRNDT.add(pnlMRAPR,"MRN Approval");
				jtpTRNDT.add(pnlMRAPR,"MRN Aprvl");
		        intMRAPR = L_intTABCT;
		        tblMRAPR.addMouseListener(this);
		        L_intTABCT++;
		    }
			else if(L_strCODCD.equals("LVAUT"))
		    {
		        jtpTRNDT.add(pnlLVAUT,"Leave Auth");
				intLVAUT = L_intTABCT;
				L_intTABCT++;
		    }
		}
		...
		JComboBox cmbVPAUT = new JComboBox();
		JComboBox cmbAPRMR = new JComboBox();
		...
		cmbVPAUT.addItem("Select");
		cmbVPAUT.addItem("Approved");
		cmbVPAUT.addItem("Not Approved");
		cmbVPAUT.addItem("Held For Discussion");

		cmbAPRMR.addItem("Select");
		cmbAPRMR.addItem("Held For Discussion");
		cmbAPRMR.addItem("Authorised");
		
		tblINAUT.setCellEditor(TBL_APRFL,cmbAUTST);
		tblGPAPR.setCellEditor(TBL_APRFL,cmbGPAUT);
		tblVSTAUT.setCellEditor(TB5_APRFL,cmbVPAUT);
		tblMRAPR.setCellEditor(TB6_APRFL,cmbAPRMR);
		
		tblVSTAUT.setColumnColor(TB5_APRFL,java.awt.Color.blue);
		...
		//// PTF ENTRY SCREEN
			...
			tblPTFDT = crtTBLPNL1(pnlPTFDT,L_TBLHD,500,5,1,11,7,L_COLSZ,new int[]{0});
	...
	public void actionPerformed(ActionEvent L_AE)
	{
		...
		try
		{
			 ...
			 if(M_objSOURC == btnRPMRN)
			{
				...
				String L_strMRNNO ="";
				String L_strVENCD ="";
			    for(i=0;i<tblMRAPR.getRowCount();i++)
				{
					if(tblMRAPR.getValueAt(i,TB6_DSPFL).toString().equals("true"))
					{
						objMRNRP  = new mm_rpmrn("01"+hstCODCD.get(tblMRAPR.getValueAt(i,TB6_STRTP).toString()).toString()+"00");
						L_strMRNNO = tblMRAPR.getValueAt(i,TB6_MRNNO).toString();
						L_strVENCD = tblMRAPR.getValueAt(i,TB6_VENCD).toString();
						//L_strSTRTP = tblINAUT.getValueAt(i,TBL_DOCNO).toString();
						objMRNRP.genREPORT(L_strMRNNO,L_strMRNNO,0,L_strVENCD);
						break;
					}
				}
				...
				try
				{
					Runtime r = Runtime.getRuntime();
					Process p = null;
					p  = r.exec("c:\\windows\\wordpad.exe "+cl_dat.M_strREPSTR_pbst+"mm_rpmrn.doc"); 
				}
				catch(Exception L_EX)
				{
					setMSG(L_EX,"Error.exescrn.. ");
			 ...
			 if(M_objSOURC == btnRPVST)
			 {
				 ...
				 int i=0;
			     for(i=0;i<tblVSTAUT.getRowCount();i++)
				 {
					if(tblVSTAUT.getValueAt(i,TB5_DSPFL).toString().equals("true"))
					{
						L_strVGPNO = tblVSTAUT.getValueAt(i,TB5_VSPNO).toString();
						//L_strSTRTP = tblINAUT.getValueAt(i,TBL_DOCNO).toString();
				  		objRPVGP.getDATA(L_strVGPNO,L_strVGPNO);
						try
						{	
							Runtime r = Runtime.getRuntime();
							Process p = null;
					...
					if(L_intCNT == 0)
					{
						setMSG("Please select a document to view details..",'E');
					}
				}
			...
			if((M_objSOURC == txtLOTNO)||(M_objSOURC == txtRCLNO))// For classification screen
			{
        		...
        		M_strSQLQRY = "SELECT MAX(LT_RCLNO) L_RCLNO from PR_LTMST WHERE LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_PRDTP = '"+cmbPRDTP.getSelectedItem().toString().substring(0,2) +"'";
	      ...
	      else if(M_objSOURC == btnPRINT)
		  {
              try
              {
                ...
                M_strSQLQRY = " SELECT distinct PTF_PTFDT from FG_PTFRF WHERE PTF_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PTF_PTFNO ='"+strPRPTF +"'";
                M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
                if(M_rstRSSET !=null)
                if(M_rstRSSET.next())
                {
	...
	private void getDOCDT(ResultSet P_rstRSSET,cl_JTable P_tblGPDTL) throws Exception
	{
		...
		if(P_rstRSSET !=null)
		{
			...
			while(P_rstRSSET.next())
			{
				...
				M_strSQLQRY ="SELECT RM_DOCTP,RM_REMDS FROM MM_RMMST WHERE RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP ='"+L_strSTRTP +"'"
	...
	private void getITDTL(cl_JTable P_tblGPDTL,cl_JTable P_tblITMDT) throws Exception 
	{
		...
		+"FROM MM_GPTRN,CO_CTMST WHERE CT_MATCD = GP_MATCD AND GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and GP_STRTP = '"+hstCODCD.get(P_tblGPDTL.getValueAt(L_intSELROW,TBL_STRTP).toString()).toString()+"' AND "
	...
	private void getINDTL() throws Exception 
	{
		...
		M_strSQLQRY = "SELECT IN_MATCD,IN_INDQT,isnull(IN_INDVL,0) IN_INDVL,IN_REQDT,IN_EXPDT,IN_TCFFL,IN_INSFL,CT_MATDS,CT_UOMCD "
		+"FROM MM_INMST,CO_CTMST WHERE CT_MATCD = IN_MATCD AND IN_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and IN_STRTP = '"+hstCODCD.get(tblINAUT.getValueAt(L_intSELROW,TBL_STRTP).toString()).toString()+"'"
		...
		if(M_rstRSSET !=null)
		{
			...
			while(M_rstRSSET.next())
			{
				...
				tblITDT3.setValueAt(setNumberFormat(M_rstRSSET.getDouble("IN_INDVL"),0),i,9);
				L_dblINTOTVL += M_rstRSSET.getDouble("IN_INDVL");
				i++;
			}
			tblITDT3.setValueAt("Total:",i+1,6);
			tblITDT3.setValueAt(setNumberFormat(L_dblINTOTVL,0),i+1,9);
		}
	}
	private void getMRDTL() throws Exception 
	{
		int L_intSELROW = tblMRAPR.getSelectedRow();
		if(tblMRAPR.getValueAt(L_intSELROW,TB6_DSPFL).equals("false"))
		{
			tblITDT4.clrTABLE();
			return;
		}
		...
		for(i=0;i<tblMRAPR.getRowCount();i++)
		if(i != L_intSELROW)
			tblMRAPR.setValueAt(new Boolean(false),i,TB6_DSPFL);
		M_strSQLQRY = "SELECT MR_MATCD,MR_RETQT,MR_RCNFL,MR_MRNRT,CT_MATDS,CT_UOMCD "
		+"FROM MM_MRMST,CO_CTMST WHERE CT_MATCD = MR_MATCD AND MR_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and MR_STRTP = '"+hstCODCD.get(tblMRAPR.getValueAt(L_intSELROW,TB6_STRTP).toString()).toString()+"'"
		+" AND MR_MRNNO = '"+tblMRAPR.getValueAt(L_intSELROW,TB6_MRNNO).toString()+"' AND MR_STSFL <>'X'";
		tblITDT4.clrTABLE();
		M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
		i=0;
		if(M_rstRSSET !=null)
		{
			while(M_rstRSSET.next())
			{
				tblITDT4.setValueAt(M_rstRSSET.getString("MR_MATCD"),i,1);
				tblITDT4.setValueAt(M_rstRSSET.getString("CT_UOMCD"),i,2);
				tblITDT4.setValueAt(M_rstRSSET.getString("CT_MATDS"),i,3);
				tblITDT4.setValueAt(M_rstRSSET.getString("MR_RETQT"),i,4);
				tblITDT4.setValueAt(M_rstRSSET.getString("MR_MRNRT"),i,5);
				/*datTEMP = M_rstRSSET.getDate("IN_REQDT");
				if(datTEMP !=null)
				{
					tblITDT3.setValueAt(M_fmtLCDAT.format(datTEMP),i,5);
				...
				if(L_strTEMP.equals("Y"))
					...
					tblITDT3.setValueAt(Boolean.FALSE,i,7);*/
				L_strTEMP = nvlSTRVL(M_rstRSSET.getString("MR_RCNFL"),"");
				if(L_strTEMP.equals("Y"))
					tblITDT4.setValueAt(Boolean.TRUE,i,6);
				else
					tblITDT4.setValueAt(Boolean.FALSE,i,6);
				i++;
			}
		}
	}
			...
			if(M_objSOURC == jtpTRNDT)
			{
                ...
                if(jtpTRNDT.getSelectedIndex() ==intGPAPR)
				{
					...
					M_strSQLQRY = "SELECT DISTINCT GP_STRTP,GP_MGPTP,GP_MGPNO,GP_MGPDT,GP_DPTCD,GP_APRVL,GP_VENCD,GP_PREBY,GP_VEHNO,GP_VEHDS,GP_STSFL FROM MM_GPTRN "
						+"WHERE GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and isnull(GP_STSFL,'') in('1','2') AND GP_FRWTO = '"+cl_dat.M_strUSRCD_pbst+"'";					
				//	System.out.println(M_strSQLQRY);
					M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intGPAUT)
				{
					...
					M_strSQLQRY = "SELECT DISTINCT GP_STRTP,GP_MGPTP,GP_MGPNO,GP_MGPDT,GP_DPTCD,GP_APRVL,GP_VENCD,GP_PREBY,GP_VEHNO,GP_VEHDS,GP_STSFL FROM MM_GPTRN "
						+"WHERE GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and isnull(GP_STSFL,'') = '3'";					
				//	System.out.println(M_strSQLQRY);
					M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intINAPR)
				{
					...
					M_strSQLQRY = "SELECT DISTINCT IN_INDTP,IN_STRTP,IN_INDNO,IN_DPTCD,IN_FRWBY,IN_STSFL,sum(IN_INDVL) L_APRVL FROM MM_INMST "
							+"WHERE IN_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and isnull(IN_STSFL,'') IN ('2','3') and IN_FRWTO ='"+cl_dat.M_strUSRCD_pbst+"' and isnull(IN_STSFL,'') <>'X'"
					...
					if(M_rstRSSET !=null)
					{
						while(M_rstRSSET.next())
						{
							...
							M_strSQLQRY ="SELECT RM_REMTP,RM_REMDS FROM MM_RMMST WHERE RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP ='"+L_strSTRTP +"'"
				...
				else if(jtpTRNDT.getSelectedIndex() ==intMRAPR)
				{
					ResultSet L_rstRSSET;
					String L_strSTRTP="",L_strMRNNO ="",L_strMRNTP="",L_strTEMP ="";
					int L_intROWCNT=0;
					tblMRAPR.setEnabled(false);
					//tblITDT6.setEnabled(false);
					tblMRAPR.cmpEDITR[TB6_CHKFL].setEnabled(true);
					tblMRAPR.cmpEDITR[TB6_DSPFL].setEnabled(true);
					tblMRAPR.cmpEDITR[TB6_APRFL].setEnabled(true);
					
					M_strSQLQRY = "SELECT DISTINCT MR_STRTP,MR_MRNNO,MR_DPTCD,MR_FRWBY,MR_STSFL,sum(MR_MRNVL) L_APRVL FROM MM_MRMST "
							+"WHERE MR_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and isnull(MR_STSFL,'') IN ('1','3') and MR_FRWTO ='"+cl_dat.M_strUSRCD_pbst+"' and isnull(MR_STSFL,'') <>'X'"
						    +" group by MR_STRTP,MR_MRNNO,MR_DPTCD,MR_FRWBY,MR_STSFL ORDER BY MR_STRTP,MR_MRNNO ";
					tblINAUT.clrTABLE();
					M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
					int i=0;
					if(M_rstRSSET !=null)
					{
						...
						{
							L_intROWCNT++;
							L_strSTRTP = M_rstRSSET.getString("MR_STRTP");
							L_strMRNNO = M_rstRSSET.getString("MR_MRNNO");
							
							L_strTEMP = nvlSTRVL(M_rstRSSET.getString("MR_STSFL"),"");
							tblMRAPR.setValueAt(hstCODDS.get(L_strSTRTP).toString(),i,TB6_STRTP);
							tblMRAPR.setValueAt(M_rstRSSET.getString("MR_MRNNO"),i,TB6_MRNNO);
							tblMRAPR.setValueAt(hstCODDS.get(M_rstRSSET.getString("MR_DPTCD")).toString(),i,TB6_DPTCD);
							tblMRAPR.setValueAt(nvlSTRVL(M_rstRSSET.getString("L_APRVL"),"0.00"),i,TB6_APRVL);
							tblMRAPR.setValueAt(nvlSTRVL(M_rstRSSET.getString("MR_FRWBY"),""),i,TB6_PREBY);
							
							if(L_strTEMP.equals("3"))
							{
								L_strTEMP = "Held For Discussion";
								tblMRAPR.setValueAt(L_strTEMP,i,TB6_APRFL);
							}
							M_strSQLQRY ="SELECT RM_REMTP,RM_REMDS FROM MM_RMMST WHERE RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP ='"+L_strSTRTP +"'"
							 +" AND RM_TRNTP ='MR' AND RM_DOCNO ='"+L_strMRNNO +"' AND isnull(RM_STSFL,'') <>'X'";										
							L_rstRSSET = cl_dat.exeSQLQRY1(M_strSQLQRY);
							String L_strREMDS ="";
							if(L_rstRSSET !=null)
							{
								...
								{
									L_strREMDS = nvlSTRVL(L_rstRSSET.getString("RM_REMDS"),"");
									tblMRAPR.setValueAt(L_strREMDS,i,TB6_REMDS);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intVSTGP)
				{
					tblVSTAUT.clrTABLE();
					tblVSTAUT.cmpEDITR[TB5_APRFL].setEnabled(true);
				//	System.out.println("call to getINVST");
					getINVST();
				}
				else if(jtpTRNDT.getSelectedIndex() ==intLVAUT)
				{
					if(!flgLVAUT)
					{
						System.out.println("calling..");
						hr_telve telve = new hr_telve(pnlLVAUT);
						System.out.println("called..");
						setMatrix(20,8);
						flgLVAUT = true;
					}
				}
				System.out.println("intLVAUT>>"+intLVAUT);
			}
	...
	public void mouseReleased(MouseEvent L_ME)
	{
		try
		{
			...
			else if((M_objSOURC == tblMRAPR)&&(tblMRAPR.getSelectedColumn() == TB6_DSPFL))
			{
				setMSG("",'N');
				getMRDTL();
			}
			...
			else if((M_objSOURC == tblVSTAUT)&&(tblVSTAUT.getSelectedColumn() == TB5_DSPFL))
			{
				int L_intSELROW = tblVSTAUT.getSelectedRow();
				for(int i=0;i<tblVSTAUT.getRowCount();i++)
				if(i != L_intSELROW)
					tblVSTAUT.setValueAt(new Boolean(false),i,TB5_DSPFL);
	...
	public void keyPressed(KeyEvent L_KE)
	{
		...
		else if(L_KE.getKeyCode() == L_KE.VK_F1)
		{
			if(M_objSOURC == txtLOTNO)
			{
        	    ...
        	    M_strSQLQRY = "select LT_LOTNO,LT_RCLNO,LT_PSTDT,PR_PRDDS,CMT_SHRDS,LT_CLSFL,isnull(LT_BAGQT,0) LT_BAGQT from PR_LTMST,CO_PRMST,co_cdtrn where LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_PRDTP = '";
                M_strSQLQRY += cmbPRDTP.getSelectedItem().toString().substring(0,2) + "' and ltrim(str(LT_TPRCD,20,0)) = PR_PRDCD and  " ;
				if(chrCLSFL == 'P')
					M_strSQLQRY += "((LT_CLSFL in('1','3')) OR (LT_CLSFL ='9' and LT_PPRCD is null))";
				else
					M_strSQLQRY += " LT_CLSFL in('0','1','3','4') and SUBSTRING(ltrim(str(lt_prdcd,20,0)),1,3) <> '512' and SUBSTRING(LT_LOTNO,1,2) not in ('99','91')" ;
				...
				M_strSQLQRY += " AND cmt_cgmtp ='SYS' and cmt_cgstp = 'QCXXCLS' and LT_CLSFL = cmt_codcd ";
	         	if(txtLOTNO.getText().trim().length() >0)
					M_strSQLQRY += " and LT_LOTNO like '" + txtLOTNO.getText().trim() + "%'  AND LT_STSFL <> 'X'";
				M_strSQLQRY += " order by LT_PSTDT desc";
    		...
    		else if(L_KE.getSource().equals(txtRCLNO))
			{
				cl_dat.M_flgHELPFL_pbst = true;
			    M_strSQLQRY = " ";
			    M_strSQLQRY = "select LT_RCLNO,PR_PRDDS from PR_LTMST,CO_PRMST where ltrim(str(LT_PRDCD,20,0)) = PR_PRDCD AND LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_LOTNO = ";
		    ...
		    else if(M_objSOURC == txtRCLOT)
			{
				setCursor(cl_dat.M_curWTSTS_pbst);
				cl_dat.M_flgHELPFL_pbst = true;
				M_strSQLQRY = "SELECT distinct ST_LOTNO,PR_PRDDS,sum(st_stkqt) from fg_STMST,CO_PRMST where ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and SUBSTRING(ST_LOTNO,1,3) not in "+strSCPLT_fn;
			...
			{
				String L_strPTFLS = getPTFLS(cl_dat.M_strUSRCD_pbst);
				M_strSQLQRY = "Select SUBSTRING(CMT_CODCD,5,2),CMT_CODDS from CO_CDTRN where CMT_CGMTP='SYS'";
        		M_strSQLQRY += " and CMT_CGSTP = 'FGXXCAT' and SUBSTRING(CMT_CODCD,1,4)='PTF_' and int(SUBSTRING(CMT_CODCD,5,2)) in "+L_strPTFLS; 
					/*cmt_modls like '%"+cl_dat.M_strUSRTP_pbst+"%'";*/
				System.out.println(M_strSQLQRY);
        		cl_dat.M_flgHELPFL_pbst = true;
	...
	private String getPTFLS(String LP_USRCD)
	{
		String L_strRETSTR = "";
		try
		{
			M_strSQLQRY = "select isnull(cmt_modls,'') cmt_modls from CO_CDTRN where cmt_cgmtp = 'A"+cl_dat.M_strCMPCD_pbst+"' and cmt_cgstp = 'COXXAUT' and cmt_codcd = '"+LP_USRCD+"_LTPTF'";
			System.out.println(M_strSQLQRY);
			ResultSet L_rstRSSET = cl_dat.exeSQLQRY2(M_strSQLQRY);
			if (L_rstRSSET != null && L_rstRSSET.next())
				L_strRETSTR = L_rstRSSET.getString("CMT_MODLS");
			L_strRETSTR = "("+L_strRETSTR+")";
		}
		catch(Exception L_E)
		{
			setMSG(L_E,"getPTFLS");
...
void setENBL(boolean L_flgSTAT)
{
	...
	tblVSTAUT.cmpEDITR[TB5_VSTNM].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSORG].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSTCT].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_PERVS].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_PURPS].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSARA].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_ARADS].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSTDT].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VLDTM].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSCAT].setEnabled(false);
	tblVSTAUT.cmpEDITR[TB5_VSPNO].setEnabled(false);
	tblITDT4.setEnabled(false);
...
private boolean getLOTDET()
{
	...
	String L_strPSTDT="",L_strPENDT="",L_strADDTM="",L_strADDBY="",L_strENDTM="",L_strENDBY="";
	flgOFFGRD = false;
	strPTAFL ="";
	try
	{
	    strMSG ="";
         ...
         +" LT_PPRCD,LT_PCLTM,LT_CPRCD,LT_CLSTM,LT_CLSBY,LT_IPRDS,LT_PTAFL,LT_PSTDT,LT_PENDT,LT_ADDTM,LT_ADDBY,LT_ENDTM,LT_ENDBY,PR_PRDDS,"
         +" PR_STSFL,QP_QPRCD,QP_ORDBY FROM PR_LTMST,CO_QPMST,CO_PRMST WHERE"
         +" ltrim(str(LT_PRDCD,20,0)) = PR_PRDCD and LT_PRDCD = QP_PRDCD and QP_QCATP = "+ "'"+cmbPRDTP.getSelectedItem().toString().substring(0,2) + "'"
         +" and QP_SRLNO = " + "'" + strDFLSR_fn + "'"
         +" and QP_ENDDT is null and QP_ORDBY is not null "
         +" and LT_CMPCD = '" + cl_dat.M_strCMPCD_pbst + "'"
		...
		L_strPSTDT="";L_strPENDT="";L_strADDTM="";L_strADDBY="";L_strENDTM="";L_strENDBY="";		
		if(L_rstRSSET.getTimestamp("LT_PSTDT")!=null)
			L_strPSTDT = M_fmtLCDTM.format(L_rstRSSET.getTimestamp("LT_PSTDT"));
		if(L_rstRSSET.getTimestamp("LT_PENDT")!=null)
			L_strPENDT = M_fmtLCDTM.format(L_rstRSSET.getTimestamp("LT_PENDT"));
		if(L_rstRSSET.getTimestamp("LT_ADDTM")!=null)
			L_strADDTM = M_fmtLCDTM.format(L_rstRSSET.getTimestamp("LT_ADDTM"));
		if(L_rstRSSET.getString("LT_ADDBY")!=null)
			L_strADDBY = L_rstRSSET.getString("LT_ADDBY");
		if(L_rstRSSET.getTimestamp("LT_PENDT")!=null && L_rstRSSET.getTimestamp("LT_ENDTM") !=null)
		{
		    L_strENDTM = M_fmtLCDTM.format(L_rstRSSET.getTimestamp("LT_ENDTM"));
			L_strENDBY = nvlSTRVL(L_rstRSSET.getString("LT_ENDBY"),"");
		}
		strPTARM ="";
		btnRLS.setVisible(false); 
		if(strPTAFL.equals("Y"))
		{
    		M_strSQLQRY = "SELECT RM_REMDS FROM QC_RMMST WHERE RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_QCATP ='01' AND RM_TSTTP ='LOT' AND RM_TSTNO ='"
		...
		else if((L_strCLSFL.equals(strFNLST_fn)) &&(jtpTRNDT.getTitleAt(jtpTRNDT.getSelectedIndex()).equals(strFNLCL_fn)))
		{
			...
			M_strSQLQRY += " PTF_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PTF_LOTNO = '"+txtLOTNO.getText().trim()+"' AND PTF_PRDTP  ='"+cmbPRDTP.getSelectedItem().toString().substring(0,2)+"'"; 
			System.out.println(M_strSQLQRY);
			M_rstRSSET = cl_dat.exeSQLQRY2(M_strSQLQRY);
			if(M_rstRSSET !=null)
			{
		...
		txtPENDT.setText(L_strPENDT);
		txtENDBY.setText(L_strENDBY);
		
		lblPSTDT.setText(L_strPSTDT);
		lblPENDT.setText(L_strPENDT);
		lblADDTM.setText(L_strADDTM);
		lblADDBY.setText(L_strADDBY);
		lblENDTM.setText(L_strENDTM);
		lblENDBY.setText(L_strENDBY);
...
private boolean getTSTDET(String P_strQCATP)
{
	...
	try
	{
    	...
    	strTSTNO ="";
    	M_strSQLQRY = "Select * from QC_PSMST where PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PS_QCATP = '" + P_strQCATP + "' and PS_LOTNO = '" ;
		M_strSQLQRY += txtLOTNO.getText().trim() + "'";
		M_strSQLQRY += " AND PS_RCLNO = '"+txtRCLNO.getText().trim() + "'";
		M_strSQLQRY += " and PS_TSTTP in ('0103','0104')";
		M_strSQLQRY += " AND isnull(PS_STSFL,'') <> 'X'";
		M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
		hstCMPVL = new Hashtable<String,String>();
		hstBAGVL = new Hashtable<String,String>();
		hstCMPVL.clear();
		hstBAGVL.clear();
		if(M_rstRSSET ==null)
		{
...
private void getALLREC()
{
    try
    {
	   ...
	   String L_strCHKCD ="";
	   String L_strCMPFL;
	   hstHSTST = new Hashtable<String,String>();
	   tblTSTDT.clrTABLE();
       exeINTGRB();
       M_strSQLQRY = " ";
	   if (!txtCPRCD.getText().trim().equals(""))
	   ...
	   M_strSQLQRY += " and LT_CMPCD = '" +cl_dat.M_strCMPCD_pbst + "'";
	   M_strSQLQRY += " and LT_LOTNO = '" + txtLOTNO.getText().trim() + "'";
...
private void getGRADDT()// Grab and additional details
{
    ...
    try
    {
		if(hstHSTST !=null)
			hstHSTST.clear();
		M_strSQLQRY ="Select * from QC_PSMST where PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and isnull(PS_STSFL,'') <> 'X'" ;
...
private void getRMK(String P_strLOTNO,String P_strTSTNO)
{
	...
	M_strSQLQRY += " RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_QCATP = '"+cmbPRDTP.getSelectedItem().toString().substring(0,2)+"' AND RM_TSTTP  ='"+strCLSTP_fn+"' and RM_TSTNO ='"+P_strLOTNO.trim()+"' ";
...
private void getTSRMK(String P_strTSTNO,String P_strTSTTP)
{
	ResultSet L_RSLRMK;
	String L_TSTRMK = "" ;
    M_strSQLQRY = "Select RM_TSTTP, RM_REMDS from QC_RMMST where RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_QCATP = '" + cmbPRDTP.getSelectedItem().toString().substring(0,2).trim() + "' and RM_TSTTP = '" ;
		    ...
		    try
		    {
    			...
    			if(input == txtRCLOT)
    			{
    			   if(txtRCLOT.getText().length() != 8)
    			    return true;
    			    flgLTVLD = false;
    			    M_strSQLQRY = "SELECT LT_LOTNO from PR_LTMST where LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and SUBSTRING(LT_LOTNO,1,3) not in "+strSCPLT_fn;		
	...
	boolean vldDATA()
	{
		try
		{
			...
			else if(jtpTRNDT.getSelectedIndex() ==intVSTGP)
			{
				...
				for(int i=0;i<tblVSTAUT.getRowCount();i++)
				{
					if(tblVSTAUT.getValueAt(i,TB5_CHKFL).toString().equals("true"))
					{
						L_intSELCT++;
						//System.out.println("checked true "+tblVSTAUT.getValueAt(i,TB5_APRFL).toString()+"value");
						if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals(" "))
						{
							//System.out.println("blank");
							setMSG("Please Select the Authorisation Tag at line "+(i+1) + "..",'E');
							return false;
						}
						if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals("null"))
						{
							//System.out.println("null flag");
							setMSG("Please Select the Authorisation Tag at line "+(i+1) + "..",'E');
							return false;
						}
						if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals("Select"))
						{
		...
		try
		{
			...
			if(cl_dat.M_cmbOPTN_pbst.getSelectedItem().toString().equals(cl_dat.M_OPAUT_pbst))
			{
				...
				if(jtpTRNDT.getSelectedIndex() ==intGPAPR)
				{
					...
					for(int i=0;i<tblGPAPR.getRowCount();i++)
					{
						...
						{	
							...
							+"WHERE GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and GP_STRTP = '"+hstCODCD.get(tblGPAPR.getValueAt(i,TBL_STRTP).toString()).toString()+"' AND GP_MGPTP = '"
							...
							M_strSQLQRY = "Select RM_REMDS from MM_RMMST where RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP = '"+hstCODCD.get(tblGPAPR.getValueAt(i,TBL_STRTP).toString()).toString()+"' and RM_TRNTP = 'GP'  and RM_DOCNO = '"+L_strMGPNO+"'";
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							String L_REMDS_GP ="";
							if(M_rstRSSET != null  && M_rstRSSET.next())
							{
								L_REMDS_GP = "\n Gate Pass Remark : "+M_rstRSSET.getString("RM_REMDS");
								M_rstRSSET.close();
							}
							...
							if(M_rstRSSET.next())
							{
								...
								if(L_strEML.length() >0)
									ocl_eml.sendfile(L_strEML,null,"Gate Pass No. :"+L_strMGPNO + L_STSDS+cl_dat.M_strUSRCD_pbst,"Gate Pass No. :"+L_strMGPNO + L_STSDS+cl_dat.M_strUSRCD_pbst+L_REMDS_GP);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intGPAUT)
				{
					...
					for(int i=0;i<tblGPAUT.getRowCount();i++)
					{
						if(tblGPAUT.getValueAt(i,TBL_CHKFL).toString().equals("true"))
						{
							...
							+"WHERE GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and GP_STRTP = '"+hstCODCD.get(tblGPAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"' AND GP_MGPTP = '"
							...
							{
								M_strSQLQRY = "update mm_gptrn set gp_duedt = date(days(gp_duedt)+days(getdate())-days(GP_MGPDT)) "
										+"WHERE GP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and GP_STRTP = '"+hstCODCD.get(tblGPAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"' AND GP_MGPTP = '51'"
							...
							M_strSQLQRY = "Select RM_REMDS from MM_RMMST where RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP = '"+hstCODCD.get(tblGPAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"' and RM_TRNTP = 'GP' and RM_DOCNO = '"+L_strMGPNO+"'";
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							String L_REMDS_GP ="";
							if(M_rstRSSET != null  && M_rstRSSET.next())
							{
							...
							while(M_rstRSSET.next())
							{
								L_strEML = M_rstRSSET.getString("US_EMLRF");
								if(L_strEML.length() >0)
									ocl_eml.sendfile(L_strEML,null,"Gate Pass No. : "+ L_strMGPNO + " is Authorised for Gate out. ","Gate Pass No. : "+ L_strMGPNO + " is Authorised for Gate out. "+L_REMDS_GP);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intINAPR)
				{
					...
					for(int i=0;i<tblINAUT.getRowCount();i++)
					{
						if(tblINAUT.getValueAt(i,TBL_CHKFL).toString().equals("true"))
						{
							...
							M_strSQLQRY +=" WHERE IN_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and IN_STRTP = '"+hstCODCD.get(tblINAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"'"
							...
							if(L_strSTSFL.equals("4"))
							{
								M_strSQLQRY = "update mm_inmst set in_porby = date(days(in_porby)+days(CURRENT_DATE)-days(IN_INDDT)),in_reqdt = date(days(in_reqdt)+days(CURRENT_DATE)-days(IN_INDDT)) "
										...
										+"WHERE IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and IN_STRTP = '"+hstCODCD.get(tblINAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"'"
										+" AND IN_INDNO = '"+L_strINDNO+"' AND isnull(IN_INDTP,'') ='01'";
								cl_dat.exeSQLUPD(M_strSQLQRY,"");
							}

							M_strSQLQRY = "Select RM_REMDS from MM_RMMST where RM_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and RM_STRTP = '"+hstCODCD.get(tblINAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"' and RM_TRNTP = 'IN' and RM_DOCNO = '"+L_strINDNO+"'";
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							String L_REMDS_IN ="";
							if(M_rstRSSET != null  && M_rstRSSET.next())
							{
								L_REMDS_IN = "\n Indent Remark : "+M_rstRSSET.getString("RM_REMDS");
								M_rstRSSET.close();
							}
						...
						//	M_strSQLQRY = "Select US_EMLRF from SA_USMST WHERE US_USRCD ='"+tblINAUT.getValueAt(i,TB1_PREBY).toString()+"'";;
							M_strSQLQRY = " SELECT DISTINCT US_EMLRF L_EMLRF FROM SA_USMST,MM_INMST WHERE ((IN_PREBY =  US_USRCD) OR (IN_FRWBY =  US_USRCD)) ";
							M_strSQLQRY += " AND IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_STRTP = '"+hstCODCD.get(tblINAUT.getValueAt(i,TBL_STRTP).toString()).toString()+"' and IN_INDNO = '"+L_strINDNO+"'";

							//M_strSQLQRY = "Select US_EMLRF from SA_USMST,MM_INMST WHERE US_USRCD = '"+tblINAUT.getValueAt(i,TB1_PREBY).toString()+"'";
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							if(M_rstRSSET != null)
							while(M_rstRSSET.next())
							{
								L_strEML = M_rstRSSET.getString("L_EMLRF");
							//	System.out.println(L_strEML);
								if(L_strEML.length() >0)
									ocl_eml.sendfile(L_strEML,null,"Indent No."+ L_strINDNO + " is "+L_strAPRDS,"Indent No."+ L_strINDNO + " is "+L_strAPRDS+L_REMDS_IN);
				...
				else if(jtpTRNDT.getSelectedIndex() ==intMRAPR)
				{
					cl_dat.M_flgLCUPD_pbst = true;
					String L_strMRNNO ="";
					for(int i=0;i<tblMRAPR.getRowCount();i++)
					{
						if(tblMRAPR.getValueAt(i,TB6_CHKFL).toString().equals("true"))
						{
							L_strMRNNO = tblMRAPR.getValueAt(i,TB6_MRNNO).toString();
							if(tblMRAPR.getValueAt(i,TB6_APRFL).toString().equals("Held For Discussion"))
							{
								L_strAPRDS = "Held For Discussion";
								L_strSTSFL ="3";
							}
							else if(tblMRAPR.getValueAt(i,TB6_APRFL).toString().equals("Authorised"))
							{
								L_strAPRDS = "Authorised";
								L_strSTSFL ="4";
							}
							if(L_strSTSFL.equals(""))
							   continue; // Next Iteration
							M_strSQLQRY ="UPDATE MM_MRMST SET MR_STSFL = '"+L_strSTSFL +"',MR_LUSBY = '"
							+cl_dat.M_strUSRCD_pbst+"',MR_LUPDT = '"
							+M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"',"
							+"MR_APRBY = '"+cl_dat.M_strUSRCD_pbst+"',MR_APRDT = current_date ";
						/*	if(L_strSTSFL.equals("4"))
							{
								M_strSQLQRY +=",IN_AUTQT = IN_INDQT ";	
							}*/
							M_strSQLQRY +=" WHERE MR_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and MR_STRTP = '"+hstCODCD.get(tblMRAPR.getValueAt(i,TB6_STRTP).toString()).toString()+"'"
							+" AND MR_MRNNO = '"+L_strMRNNO+"' and isnull(MR_STSFL,'') <>'X'";
							cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
						
							// Generate email to user saying Indent is authorised.
							M_strSQLQRY = "Select US_EMLRF from SA_USMST WHERE US_USRCD ='"+tblMRAPR.getValueAt(i,TB6_PREBY).toString()+"'";;
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							if(M_rstRSSET != null)
							while(M_rstRSSET.next())
							{
								L_strEML = M_rstRSSET.getString("US_EMLRF");
								if(L_strEML.length() >0)
									ocl_eml.sendfile(L_strEML,null,"MRN No."+ L_strMRNNO + " is "+L_strAPRDS,"MRN No."+ L_strMRNNO + " is "+L_strAPRDS);
									//ocl_eml.sendfile(L_strEML,null,"Intimation of Indent Authorisation","Indent No."+ L_strINDNO + " is "+L_strAPRDS);
							}
							if(M_rstRSSET != null)
							M_rstRSSET.close();
...
/////
				else if((jtpTRNDT.getSelectedIndex() ==intVSTGP))
				{
					...
					for(int i=0;i<tblVSTAUT.getRowCount();i++)
					{
						if(tblVSTAUT.getValueAt(i,TB5_CHKFL).toString().trim().equals("true"))
						{
							if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals("Held For Discussion"))
							{
								L_strAPRDS = "Held For Discussion";
								L_strSTSFL ="3";
							}
							else if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals("Not Approved"))
							{
								L_strAPRDS = "Not Approved";
								L_strSTSFL ="2";
							}
							else if(tblVSTAUT.getValueAt(i,TB5_APRFL).toString().equals("Approved"))
							{
								L_strAPRDS = "Approved";
								L_strSTSFL ="4";
							}
							...
							M_strSQLQRY += "VS_CMRFL = '" + (tblVSTAUT.getValueAt(i,TB5_CMRFL).toString().equals("true") ? "Y" : "N")+"',";
							M_strSQLQRY += "VS_MOBFL = '" + (tblVSTAUT.getValueAt(i,TB5_MOBFL).toString().equals("true") ? "Y" : "N")+"',";
							M_strSQLQRY += "VS_LUSBY = " + "'" + cl_dat.M_strUSRCD_pbst+"',";
							M_strSQLQRY += "VS_CLRBY = " + "'" + cl_dat.M_strUSRCD_pbst+"',";
							M_strSQLQRY += "VS_STSFL = '"+L_strSTSFL +"',";
							M_strSQLQRY += "VS_LUPDT = '" + M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"'";
							M_strSQLQRY += " WHERE  ";
							M_strSQLQRY += "  VS_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND VS_VSPNO = " + "'" + tblVSTAUT.getValueAt(i,TB5_VSPNO).toString().trim()+"'";
							cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
							if(tblVSTAUT.getValueAt(i,TB5_REMDS).toString().trim().length() >0)
                			{
								M_strSQLQRY ="UPDATE HR_RMMST SET ";
								M_strSQLQRY += "RM_REMDS = " + "'" + tblVSTAUT.getValueAt(i,TB5_REMDS).toString().trim() +"'";
								M_strSQLQRY += " where RM_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND RM_TRNTP ='HC' and RM_TRNCD ='01' and RM_DOCNO = '" + tblVSTAUT.getValueAt(i,TB5_VSPNO).toString().trim()+"'";
								cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
                			}
						
							M_strSQLQRY = "Select US_EMLRF from SA_USMST WHERE US_USRCD ='"+tblVSTAUT.getValueAt(i,TB5_REQBY).toString()+"'";
							M_rstRSSET = cl_dat.exeSQLQRY(M_strSQLQRY);
							if(M_rstRSSET != null)
							if(M_rstRSSET.next())
							{
								...
								L_BODDS ="";
                                L_strEML = M_rstRSSET.getString("US_EMLRF");
                                if(L_strSTSFL.equals("2")) // Held For Discussion
                                    L_STSDS =" is Not Approved ";
                                else if(L_strSTSFL.equals("3"))
                                    L_STSDS =" is Held for Discussion";
								 else if(L_strSTSFL.equals("4"))
                                    L_STSDS =" is Approved";
								L_STSDS = "Visit of : "+tblVSTAUT.getValueAt(i,TB5_VSTNM).toString() +L_STSDS;
								if(L_strSTSFL.equals("4"))
								{	 
									if(tblVSTAUT.getValueAt(i,TB5_CMRFL).toString().equals("true"))
										L_BODDS = " Camera Permission is given. ";
									/*else
										L_BODDS = " Camera Permission is not given, ";*/
								
									if(tblVSTAUT.getValueAt(i,TB5_MOBFL).toString().equals("true"))
										L_BODDS += " Mobile Permission is given.";
									/*else
										L_BODDS += " Mobile Permission is not given";*/
								}
								
								if(L_strEML.length() >0)
								{	
									//System.out.println(L_strEML);
									//System.out.println(L_STSDS);
									//System.out.println(L_BODDS);
									ocl_eml.sendfile(L_strEML,null,L_STSDS,L_BODDS);
								}
									//ocl_eml.sendfile(L_strEML,null,"Intimation of Gate Pass Approval","Gate Pass No."+L_strMGPNO + L_STSDS+cl_dat.M_strUSRCD_pbst);
							}
							if(M_rstRSSET != null)
    				...
    				{
						System.out.println("exeDBCMT");
				 		//setMSG("Data saved successfully..",'N');
					      clrCOMP_1();
				          	jtpTRNDT.setSelectedIndex(intVSTGP);
				      	 setMSG("Data saved successfully..",'N');
					}
    					else
    					{   
	...
	try
	{
    	...
    	*/
    	...
    	else if(jtpTRNDT.getTitleAt(jtpTRNDT.getSelectedIndex()).equals(strFNLCL_fn))
    	{
    	 ...
    	 M_strSQLQRY +=" where LT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND LT_PRDTP ='"+cmbPRDTP.getSelectedItem().toString().substring(0,2) +"'";
    	 M_strSQLQRY +=" and LT_LOTNO ='"+txtLOTNO.getText().trim() +"'";
    	 M_strSQLQRY +=" and LT_RCLNO ='"+strINTRCL_fn +"'";
    	 cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
...
private boolean getACLST(String LP_PRDTP,String LP_LOTNO,String LP_RCLNO)
{
    try
    {
        ...
        M_strSQLQRY = "select QP_QPRCD,QP_NPFVL,QP_NPTVL,QP_CMPFL,QP_TXTVL,A.* from  "
                      +" PR_LTMST,CO_QPMST,QC_PSMST A where ltrim(str(LT_TPRCD,20,0)) = QP_PRDCD AND  LT_CMPCD = PS_CMPCD and LT_LOTNO = PS_LOTNO AND LT_RCLNO = PS_RCLNO "
                      +" AND PS_QCATP ='"+LP_PRDTP +"' AND PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PS_TSTTP ='0103' AND QP_QCATP ='"+LP_PRDTP +"' AND QP_TSTTP ='0103' AND QP_SRLNO ='00000'"
                      +" and QP_ORDBY is not null and qp_enddt is null AND QP_CMPFL ='Y' "
                      +" AND isnull(LT_PTAFL,'') ='N' and LT_PRDTP = '"+LP_PRDTP +"' "
                      +" AND LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_LOTNO ='"+LP_LOTNO +"' AND LT_RCLNO ='"+LP_RCLNO +"'";   
...
private boolean exeCLSREC()
{
	...
	if(flgTSTFL)
	{
		  ...
		  for(int i=0;i<intQPRCT;i++)
	      {
	       ...
	       M_strSQLQRY += " where PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PS_QCATP = '" + cmbPRDTP.getSelectedItem().toString().substring(0,2) + "' and PS_TSTTP = '" + strCMPTP_fn + "' and PS_LOTNO = '" + txtLOTNO.getText().trim() + "' and PS_RCLNO ='00'";
		   cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
	...
	if(!updRMK())
	 ...
	 M_strSQLQRY += "LT_LUSBY='"+cl_dat.M_strUSRCD_pbst+"',"; 
     M_strSQLQRY += "LT_LUPDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"'";
     M_strSQLQRY += " where LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_PRDTP = '" + cmbPRDTP.getSelectedItem().toString().substring(0,2) + "' and LT_LOTNO = '" + txtLOTNO.getText().trim() + "'";
	 M_strSQLQRY += " and LT_RCLNO = '" + strINTRCL_fn + "'";
     cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
     if(cl_dat.M_flgLCUPD_pbst)
	 {
...
private boolean updRMK()
{
	...
	try
	{
		...
		M_strSQLQRY += " RMP_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_QCATP = '"+cmbPRDTP.getSelectedItem().toString().substring(0,2)+"' AND RM_TSTTP  ='"+strCLSTP_fn+"' and RM_TSTNO ='"+txtLOTNO.getText().trim()+"' ";
	   ...
	   // if(( L_RECCNT > 0)&&(!LM_CLSFL.equals("9")))
		...
		if( L_RECCNT > 0)
	    {
			...
			M_strSQLQRY += " where RM_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and RM_QCATP = '" + cmbPRDTP.getSelectedItem().toString().substring(0,2).trim() + "' and RM_TSTTP = '" + strCLSTP_fn + "' and RM_TSTNO = '" + txtLOTNO.getText().trim() + "'";
		}
...
private void dspLOTDT()
{
	...
	try
	{
    	...
    	M_strSQLQRY += " left outer join fg_stmst on lt_rclno = st_rclno and lt_lotno = st_lotno and lt_prdtp=st_prdtp and  lt_cmpcd = st_cmpcd ";
    	M_strSQLQRY += " where lt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and lt_lotno ='"+txtRCLOT.getText().trim()+"' and SUBSTRING(lt_lotno,1,3) not in "+strSCPLT_fn;
		...
		M_strSQLQRY += " and ST_LOTNO = '"+txtRCLOT.getText() +"' and st_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"'"; 
		M_rstRSSET = cl_dat.exeSQLQRY2(M_strSQLQRY);
		System.out.println(M_strSQLQRY);
		if(M_rstRSSET !=null)
		{
		...
		M_strSQLQRY +=" from FG_istrn where ist_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"' and ist_prdtp ='"+cmbRCPRD.getSelectedItem().toString().substring(0,2)+"'";
...
private void dspTSTDT(String P_strRCLNO,String P_strPRDCD)
{
	...
	try
	{
		M_strSQLQRY = "Select * from QC_PSMST where PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PS_QCATP = '" + cmbRCPRD.getSelectedItem().toString().substring(0,2) + "' and PS_RCLNO = '" ;
...
private void exeLOTRCL()
{
	try
	{
    	...
    	strRCLDOC = cl_dat.getPRMCOD("CMT_CCSVL","D"+cl_dat.M_strCMPCD_pbst,"FGXXGCH",L_strCODCD);
    	...
    	M_strSQLQRY +=" WHERE CMT_CGMTP ='D"+cl_dat.M_strCMPCD_pbst+"' and CMT_CGSTP ='FGXXGCH' and CMT_CODCD ='"+L_strCODCD.trim()+"'";
    	cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
    	setMSG("Generating the Reclassification Document number ..",'N');
    	M_strSQLQRY  = "INSERT INTO PR_LTMST(LT_CMPCD,LT_PRDTP,LT_LOTNO,LT_PRDCD,LT_CPRCD,LT_TPRCD,LT_RUNNO,LT_LINNO,LT_CYLNO,";
    	...
    	M_strSQLQRY += "select LT_CMPCD,LT_PRDTP,LT_LOTNO,";
    	...
    	M_strSQLQRY += " AND LT_LOTNO = '"+txtRCLOT.getText() +"' and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and SUBSTRING(lt_lotno,1,3) not in "+strSCPLT_fn;
    	setMSG("Inserting new record in Lot master..",'N');
		//System.out.println(M_strSQLQRY);
    	cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");
    	String L_strISSTS ="2"; // authorised
    	M_strSQLQRY = "INSERT INTO FG_ISTRN(IST_CMPCD,IST_WRHTP,IST_ISSTP,IST_ISSNO,IST_PRDCD,IST_PRDTP,IST_LOTNO,";
    	...
    	M_strSQLQRY +=" SELECT ST_CMPCD,ST_WRHTP,"; // ST_WRHTP
    	...
    	M_strSQLQRY +="ST_STSFL,"; // Stock type
    	...
    	M_strSQLQRY +=" FROM FG_STMST WHERE ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_LOTNO ='"+txtRCLOT.getText().trim()+"'";
    	...
    	M_strSQLQRY  =  "INSERT INTO FG_RCTRN(RCT_CMPCD,RCT_WRHTP,RCT_RCTTP,RCT_RCTNO,RCT_PRDTP,RCT_LOTNO,";
    	...
    	M_strSQLQRY +="ST_STSFL,";   // RCT_STKTP
    	...
    	M_strSQLQRY +=" FROM FG_STMST WHERE ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_LOTNO ='"+txtRCLOT.getText().trim()+"' AND ST_RCLNO ='"+strLSTRCL.trim() +"'";                                                          
    	M_strSQLQRY += " AND ST_STKQT >0";
		System.out.println(M_strSQLQRY);
    ...
    if(flgTSTCP)
    {
        M_strSQLQRY = "INSERT INTO QC_PSMST(PS_CMPCD,PS_QCATP,PS_TSTTP,PS_TSTNO,PS_TSTDT,PS_MORTP,PS_PRDTP,PS_LOTNO,PS_RCLNO,";
		...
		M_strSQLQRY += "'"+M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"',";
		M_strSQLQRY +="'"+cl_dat.M_strUSRCD_pbst+"'";
		M_strSQLQRY +=" FROM QC_PSMST WHERE PS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and PS_LOTNO ='"+txtRCLOT.getText().trim()+"'";
		...
		M_strSQLQRY = "INSERT INTO FG_STMST(ST_CMPCD,ST_WRHTP,ST_PRDTP,ST_LOTNO,";
		...
		M_strSQLQRY +=" SELECT ST_CMPCD,ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_MNLCD,ST_RCTDT,";
		M_strSQLQRY +="'"+strLSTPRD+"',";
	...
	//updSTMST(strPTFLOT,LM_LSTRCL);                    
    		...
    		M_strSQLQRY +=" where ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_LOTNO ='"+txtRCLOT.getText().trim()+"'";
    	...
    	if(cl_dat.M_flgLCUPD_pbst)
    	{
    	    ResultSet L_RSLSET;
        	String L_STLSQL  ="";
    		M_strSQLQRY = "SELECT * FROM PR_LTMST WHERE LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_LOTNO ='"+txtRCLOT.getText().trim()+"'";
    		...
    		if(L_RSLSET !=null)
    		{
        			...
        			if(tmsTEMP !=null)
				{
					...
					M_strSQLQRY +="LT_BENDT = null,";

        			M_strSQLQRY +="LT_IPRDS = '"+nvlSTRVL(L_RSLSET.getString("LT_IPRDS"),"")+"',";
        			M_strSQLQRY +="LT_TRNFL = '0'";
        			M_strSQLQRY += " Where LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and LT_LOTNO = '"+txtRCLOT.getText().trim() +"'";
...
public boolean chkOPTSEL()
{
	...
	try
	{
      ...
      //  {
           ...
           if(!L_MSG.equals(""))
              {
             //shubham     JOptionPane.showMessageDialog(this,L_MSG,"Error Message",JOptionPane.INFORMATION_MESSAGE);
                  L_RTNVL = false;
				  return false;
              }
           if (LM_BLKVL);
            //shubham   JOptionPane.showMessageDialog(this,"Blank test Results found, Please note","Error Message",JOptionPane.INFORMATION_MESSAGE);
      //  }
	}
	catch(Exception L_E)
	{
...
private void getPTFREC()
{
	try
	{
		...
		if(strPTFCT.equals("01"))
		{
			...
			M_strSQLQRY += "sum(ST_UCLQT) L_UCLQT from FG_STMST,PR_LTMST where ST_CMPCD = LT_CMPCD and ST_PRDTP=LT_PRDTP and ST_LOTNO=LT_LOTNO";
			M_strSQLQRY += " and ST_RCLNO=LT_RCLNO  and ST_RCLNO = '00' and ST_UCLQT > 0 and LT_STSFL <> '7'";
            M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP='01' and LT_CLSFL='9')  or (ST_PRDTP in ('01','07') and (SUBSTRING(ST_PRDCD,1,3)='512' or SUBSTRING(ST_PRDCD,1,2)='SX')  and LT_CLSFL in ('0','1','9')) or (ST_PRDTP in ('02','04','05','07') and LT_CLSFL in ('0','1','9')))";
            //M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP in ('01','02','04','05') and LT_CLSFL='9') or (ST_PRDTP='01' and SUBSTRING(ST_PRDCD,1,3)='512' and LT_CLSFL in ('0','1','9')))";
			M_strSQLQRY += " group by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP,ST_TPRCD,LT_PRDCD,LT_CLSFL,LT_REMDS";
			M_strSQLQRY += " order by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP";
		...
		else if(strPTFCT.equals("02"))
		{
			...
			M_strSQLQRY += "sum(ST_UCLQT) L_UCLQT from FG_STMST,PR_LTMST where ST_CMPCD = LT_CMPCD and ST_PRDTP=LT_PRDTP and ST_LOTNO=LT_LOTNO";
			M_strSQLQRY += " and ST_RCLNO=LT_RCLNO  and ST_RCLNO > '00' and ST_UCLQT > 0 and LT_STSFL <> '7'";
            //M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP='01' and LT_CLSFL='9') or (ST_PRDTP='01' and SUBSTRING(ST_PRDCD,1,3)='512' and LT_CLSFL in ('0','1','9')) or (ST_PRDTP in ('02','04','05') and LT_CLSFL in ('0','1','9')))";
            M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP in ('01','02','04','05','07') and LT_CLSFL='9')  or (ST_PRDTP in ('01','07') and (SUBSTRING(ST_PRDCD,1,3)='512' or SUBSTRING(ST_PRDCD,1,2)='SX')  and LT_CLSFL in ('0','1','9')))";
			M_strSQLQRY += " group by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP,ST_TPRCD,LT_PRDCD,LT_CLSFL,LT_REMDS";
			M_strSQLQRY += " order by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP";
			//M_strSQLQRY += " order by ST_WRHTP,ST_PRDTP,LT_PRDCD,ST_LOTNO,ST_RCLNO,ST_PKGTP";
		...
		//{
		//	M_strSQLQRY = "Select ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_TPRCD,LT_PRDCD,ST_PKGTP,LT_CLSFL,LT_REMDS,";
		//	M_strSQLQRY += "sum(ST_UCLQT) L_UCLQT from FG_STMST,PR_LTMST where ST_CMPCD = LT_CMPCD and ST_PRDTP=LT_PRDTP";
		//	M_strSQLQRY += " and ST_LOTNO=LT_LOTNO and ST_RCLNO=LT_RCLNO and ST_RCLNO > '00' and ST_UCLQT > 0";
        //    M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP='01' and LT_CLSFL='9') or (ST_PRDTP in ('02','04','05') and LT_CLSFL in ('0','1','9')))";
		//	M_strSQLQRY += " group by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP,ST_TPRCD,LT_PRDCD,LT_CLSFL,LT_REMDS";
		//	M_strSQLQRY += " order by ST_WRHTP,ST_PRDTP,LT_PRDCD,ST_LOTNO,ST_RCLNO,ST_PKGTP";
		//}
		else if(strPTFCT.equals("03"))
		{
			...
			M_strSQLQRY += " and ST_RCLNO=LT_RCLNO and ST_RCLNO='00' and ST_UCLQT > 0 and LT_STSFL='7'";
            //M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP='01' and LT_CLSFL='9') or (ST_PRDTP in ('02','04','05') and LT_CLSFL in ('0','1','9')))";
            M_strSQLQRY += " and LT_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and ((ST_PRDTP in ('01','02','04','05','07') and LT_CLSFL='9'))";
			M_strSQLQRY += " group by ST_WRHTP,ST_PRDTP,ST_LOTNO,ST_RCLNO,ST_PKGTP,ST_TPRCD,LT_PRDCD,LT_CLSFL,LT_REMDS";
			M_strSQLQRY += " order by ST_WRHTP,ST_PRDTP,LT_PRDCD,ST_LOTNO,ST_RCLNO,ST_PKGTP";
		}
		System.out.println(M_strSQLQRY);
...
private void genPTFNO()
{
	...
	//	System.out.println("prefix"+L_strPREFX);
		M_strSQLQRY = "Select CMT_CCSVL from CO_CDTRN where CMT_CGMTP='D"+cl_dat.M_strCMPCD_pbst+"'";
		...
		L_intPTFNO += 1;
        for(int i = 1;i < (5 - String.valueOf(L_intPTFNO).length());i++)
			L_strTEMP += "0";
		strPTFNO = cl_dat.M_strFNNYR1_pbst.substring(3,4)+L_strTEMP + String.valueOf(L_intPTFNO).trim();
		txtPTFNO.setText(strPTFNO);
		txtPTFDT.setText(cl_dat.M_strLOGDT_pbst);
		//System.out.println(strPTFNO);
	}
	catch(Exception L_EX)
	{
...
private boolean vldPTFCT()
{
	...
	{
		String L_strPTFLS = getPTFLS(cl_dat.M_strUSRCD_pbst);
		M_strSQLQRY = "Select  SUBSTRING(CMT_CODCD,5,2) L_CODCD,CMT_CHP01 from CO_CDTRN where CMT_CGMTP='SYS'";
        M_strSQLQRY += " and CMT_CGSTP = 'FGXXCAT' and SUBSTRING(CMT_CODCD,1,4)='PTF_' and CMT_CODDS = '"+txtPTFCT.getText().trim()+"' and int(SUBSTRING(CMT_CODCD,5,2)) in "+L_strPTFLS; 
		...
		if(M_rstRSSET.next())
		{
			...
			System.out.println("strPTFCT : "+strPTFCT);			
			M_rstRSSET.close();
			return true;
		}
	}
...
private void genPTFREC()
{
	try
	{
		...
		if(strPTFCHP.trim().equals(strDGRTP))
		{
			...
			//System.out.println(M_strSQLQRY);
			cl_dat.exeSQLUPD(M_strSQLQRY,"setLCLUPD");   
			strPTFRF = L_CODCD + nvlSTRVL(cl_dat.getPRMCOD("CMT_CCSVL","D"+cl_dat.M_strCMPCD_pbst,"FGXXDGR",L_CODCD),"");
		...
		{			
			...
			{	
				...
				{	
    				...
    				M_strSQLQRY += "ST_LUSBY = '"+cl_dat.M_strUSRCD_pbst+"',";
    				M_strSQLQRY += "ST_LUPDT = '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"'";
    				M_strSQLQRY += " where ST_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"'";
    				M_strSQLQRY += " and ST_WRHTP = '"+L_strWRHTP+"'";
    				...
    				M_strSQLQRY += "LT_LUSBY = '"+cl_dat.M_strUSRCD_pbst+"',";
    				M_strSQLQRY += "LT_LUPDT = '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(cl_dat.M_strLOGDT_pbst))+"'";
    				M_strSQLQRY += " where lt_cmpcd = '"+cl_dat.M_strCMPCD_pbst+"'";
    				M_strSQLQRY += " and lt_prdtp = '"+L_strPRDTP+"'";
    				...
    				M_strSQLQRY = "Insert into FG_PTFRF(PTF_CMPCD,PTF_PTFNO,PTF_PRDTP,PTF_LOTNO,";
		...
		M_strSQLQRY = "Update CO_CDTRN SET ";
		M_strSQLQRY += "CMT_CCSVL = '"+txtPTFNO.getText().substring(1)+"'";
		M_strSQLQRY += " where CMT_CGMTP = 'D"+cl_dat.M_strCMPCD_pbst+"'";
		...
		if(cl_dat.M_flgLCUPD_pbst)
		{
			if(strPTFCHP.trim().equals(strDGRTP))
			{
				strCURTM = "";
				strPTFUSR = "YES";
				//cl_cust.ocl_cust.updCDTRN("D"+cl_dat.M_strCMPCD_pbst,"FGXXDGR",L_CODCD,strCURTM,strPTFUSR);
				M_strSQLQRY = "Update CO_CDTRN set ";
    			M_strSQLQRY += "CMT_CHP01 = '"+strPTFUSR+"',";
    			M_strSQLQRY += "CMT_CHP02 = '"+strCURTM+"'";
    			M_strSQLQRY += " where CMT_CGMTP = 'D"+cl_dat.M_strCMPCD_pbst+"'";
...
private void modLINCNT()
{
	...
	// Visitor gate pass related method
	...
	{        
		...
		{    
			...
			int L_intROWCNT=0;
			Timestamp L_tmpTIME1 ;
			M_strSQLQRY ="Select * from HR_VSTRN LEFT OUTER JOIN HR_RMMST ON  VS_VSTTP = RM_TRNCD AND VS_VSPNO = RM_DOCNO AND RM_TRNTP ='HC' and RM_TRNCD ='01' ";
			M_strSQLQRY += " where VS_CMPCD = '"+cl_dat.M_strCMPCD_pbst+"' and VS_STSFL IN ('1','2','3') and VS_VSOTM IS NULL and VS_VSTTP='01' order by VS_VSPNO";
			M_rstRSSET = cl_dat.exeSQLQRY1(M_strSQLQRY);
			if(M_rstRSSET !=null)
			{
				while(M_rstRSSET.next())
				{
					L_intROWCNT++;
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSCAT"),""),L_ROWNO,TB5_VSCAT);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSPNO"),""),L_ROWNO,TB5_VSPNO);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSTNM"),""),L_ROWNO,TB5_VSTNM);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSORG"),""),L_ROWNO,TB5_VSORG);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSTCT"),""),L_ROWNO,TB5_VSTCT);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_PERVS"),""),L_ROWNO,TB5_PERVS);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_ARADS"),""),L_ROWNO,TB5_ARADS);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSTDT"),""),L_ROWNO,TB5_VSTDT);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_PURPS"),""),L_ROWNO,TB5_PURPS);
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_VSARA"),""),L_ROWNO,TB5_VSARA);
					tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("VS_REQBY"),""),L_ROWNO,TB5_REQBY);
					if(nvlSTRVL(M_rstRSSET.getString("VS_CMRFL"),"").equals("Y"))
						tblVSTAUT.setValueAt(new Boolean(true),L_ROWNO,TB5_CMRFL);
					else
						tblVSTAUT.setValueAt(new Boolean(false),L_ROWNO,TB5_CMRFL);
					
					if(nvlSTRVL(M_rstRSSET.getString("VS_MOBFL"),"").equals("Y"))
						tblVSTAUT.setValueAt(new Boolean(true),L_ROWNO,TB5_MOBFL);
					else
						tblVSTAUT.setValueAt(new Boolean(false),L_ROWNO,TB5_MOBFL);
					
					L_strSTSFL = nvlSTRVL(M_rstRSSET.getString("VS_STSFL"),"");
					if(L_strSTSFL.equals("2"))
					{
								L_strSTSFL = "Not Approved";
								tblVSTAUT.setValueAt(L_strSTSFL,L_ROWNO,TB5_APRFL);
					}
					else if(L_strSTSFL.equals("3"))
					{
								L_strSTSFL = "Held For Discussion";
				    ...
				    tblVSTAUT.setValueAt(nvlSTRVL(M_rstRSSET.getString("RM_REMDS"),""),L_ROWNO,TB5_REMDS);
				    L_tmpTIME1 = M_rstRSSET.getTimestamp("VS_VLDTM");
				    if (L_tmpTIME1 != null)
	    				{
					        L_strTEMP1 = M_fmtLCDTM.format(L_tmpTIME1);
					        tblVSTAUT.setValueAt(L_strTEMP1,L_ROWNO,TB5_VLDTM);
	    				}
				    L_tmpTIME = M_rstRSSET.getTimestamp("VS_VSITM");
	    				...
	    				if (L_tmpTIME != null)
	    				{
	    					...
	    					tblVSTAUT.setValueAt(L_strTEMP,L_ROWNO,TB5_VSTDT);
	    				}
				    L_ROWNO ++;    
