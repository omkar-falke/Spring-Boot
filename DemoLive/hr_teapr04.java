...
class hr_teapr04 extends JFrame implements ActionListener,Runnable
{
   	private File file;
	...
	private static String M_strCMPCD ="04";
    hr_teapr04()
    {
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        hr_teapr04 ohr_teapr04 = new hr_teapr04();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        hr_teapr04_thrData thr1 = new hr_teapr04_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class hr_teapr04_thrData extends Thread
{
   // Hashtable hstData;
    String strDate="",M_strCMPCD="04";
    ...
    hr_teapr04_thrData(String strDate,Connection P_conSPDBA)
    {
