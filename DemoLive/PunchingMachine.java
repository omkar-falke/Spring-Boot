/*
	...
	data is fetched from spldata.hr_slhst table.
...
public class PunchingMachine extends JFrame implements ActionListener
{
    ...
    //String strRPFNM = cl_dat.M_strREPSTR_pbst+"c:\\reports\\Punching.doc";
    String strRPFNM = "c:\\reports\\Punching.doc";
...
//       btnACCEPT.addActionListener(this);
       ...
       setVisible(true);
       conOPEN();
       //txtSTRDT.setText("19/04/2010");
	   //txtSTRTM.setText("07:00");
	   //txtENDDT.setText("19/04/2010");
  ...
  public static void main(String[] args) 
  {
   ...
   public void getREPORT()
   {
   		try
   		{
   			...
   			System.out.println(txtSTRDT.getText()+" "+txtSTRTM.getText()+":00");
   			System.out.println("CMPCD>>"+strCMPCD);
   			
   			//datSTRDTM = fmtDBDTM.parse(fmtLCDTM.format(txtSTRDT.getText()+" "+txtSTRTM.getText()+":00"));
   			//datENDDTM = fmtDBDTM.parse(fmtLCDTM.format(txtENDDT.getText()+" "+txtENDTM.getText()+":00"));
			...
			D_OUT=new DataOutputStream(F_OUT); 
	   		String L_strTEMP = " SELECT SLT_EMPCD,SLT_EMPNO,SLT_TRMID,SLT_INOCD,date(SLT_PNCTM) DATE,time(SLT_PNCTM) TIME from HR_SLHST";
	   		       L_strTEMP +=" WHERE SLT_CMPCD = '"+strCMPCD+"' and SLT_PNCTM between '"+strSTRDTM+"' and '"+strENDDTM+"' order by SLT_PNCTM";
	        String L_strDATE;
