...
public class TxtAreaLimit extends JTextArea implements KeyListener, FocusListener
{
	int size;
	boolean LM_FLLCL=false,LM_BKSFL=false;
	public TxtAreaLimit(int s)
	{
		super();
		size=s;
	...
	protected void processKeyEvent(KeyEvent ke)
	{
		...
		{System.out.println("TxtAreaLimit processKeyEvent "+e);}
	}
