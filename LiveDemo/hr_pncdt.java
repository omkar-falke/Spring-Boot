...
public class hr_pncdt extends JFrame implements ActionListener
{
	...
	String strRPFNM = "j:\\Punching.txt";
  ...
  public static void main(String[] args) 
  {
   ...
   public void getREPORT()
   {
   		try
   		{
			...
			if(strCMPCD.equals("XX"))
	   		{
		   		String strSQLQRY = " UPDATE HR_SLHST SET SLT_STSFL = '2' WHERE SLT_STSFL = '1'";
