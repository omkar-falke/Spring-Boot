...
class hr_teapr1 extends JFrame implements ActionListener,Runnable
{
   	private File file;
	...
	public void run()
    {
        try
        {
            conSPDBA=setCONDTB("01","spldata","FIMS","");
            if(conSPDBA != null)
            {
...
public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        ...
        {
			M_strCMPCD = args[0];
			hr_teapr1 ohr_teapr1 = new hr_teapr1();
	        if(thrCONNECT!=null)
				thrCONNECT.join();
			if(args[0].equals("01"))
			{
		        hr_teapr1_thrData thr1 = new hr_teapr1_thrData("TNTTerminal102AXIS1",strDATE,conSPDBA,args[0]);
				hr_teapr1_thrData thr2 = new hr_teapr1_thrData("TNTTerminal102AXIS2",strDATE,conSPDBA,args[0]);
		        hr_teapr1_thrData thr3 = new hr_teapr1_thrData("TNTTerminal102AXIS3",strDATE,conSPDBA,args[0]);
		        hr_teapr1_thrData thr4 = new hr_teapr1_thrData("TNTTerminal102AXIS4",strDATE,conSPDBA,args[0]);
		        thr1.start();
		        thr2.start();
		        thr3.start();
				thr4.start();
			...
			if(args[0].equals("11"))
			{
	        	hr_teapr1_thrData thr5 = new hr_teapr1_thrData("TNTTerminal102SPLCHENNAI1",strDATE,conSPDBA,args[0]);
				thr5.start();
		        thr5.join();
	        }
	        if(conSPDBA !=null)
   ...
   private static void prcLOG()
	{
		try
	    {
			...
			int L_intSRLNO =0;
            conSPDBA.commit();
			System.out.println("calling updSWTRN_SLT1");
            //cstSWTRN = conSPDBA.prepareCall("{call updSWTRN_SLT1(?)}");
			...
			//		{
						conSPDBA.commit();
						strSQLQRY = "UPDATE HR_SLTRN1 SET SLT_STSFL ='2' where slt_cmpcd = '"+M_strCMPCD+"'";
...
class hr_teapr1_thrData extends Thread
{
   // Hashtable hstData;
    ...
    hr_teapr1_thrData(String P_strTERNM,String strDate,Connection P_conSPDBA, String P_strCMPCD)
    {
    ...
    public void run()
    {
         ...
         try
         {
            ...
            String L_strTMP = "Select EmployeeCode,EmployeeNo,TSLogId,TerminalId,DateTimeStamp,a.userid usrid,ReasonCode,specialReason from TimeStampLog a,Employee b where a.UserId = b.userId  and DateTimeStamp between '2010-06-06 00:00:01' and '2010-06-08 23:59:59' order by a.datetimestamp desc";  // and a.datetimestamp >= '"+ strDate +"'
                ...
                while((L_rstRSSET.next())&& L_flgRUN)
                {
                  ...
                  // L_STRSQL = "insert into HR_EPALG(EPA_EMPNO,EPA_PNCTM,EPA_INOCD,EPA_TRMID,EPA_STSFL) values ("
                    //          + "'"+L_strEMPNO+"','"+L_strPNCTM+"','"+L_strINOCD+"','"+L_strTERID+"','0')";
					 L_STRSQL = "insert into HR_SLTRN1(SLT_CMPCD,SLT_EMPNO,SLT_EMPCD,SLT_PNCTM,SLT_INOCD,SLT_TRMID,SLT_STSFL) values ("
