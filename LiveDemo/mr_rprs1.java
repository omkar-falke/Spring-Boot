...
class mr_rprs1 extends cl_rbase
{
	 ...
	 mr_rprs1()
	{
		...
		try
		{
			...
			M_rstRSSET=cl_dat.exeSQLQRY0("Select  CMT_CODCD,CMT_CODDS from CO_CDTRN where CMT_CGMTP='SYS' and CMT_CGSTP='MR00SAL' and CMT_CODCD ='04' order by CMT_CODCD");
			if(M_rstRSSET!=null)
			{
	...
	@SuppressWarnings("unchecked") void exePRINT()
	{
		...
		try
		{
			...
			//old query changed by vijay on 02/24/2009
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST,CO_CDTRN where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INTSBSCD1 inn "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			
			
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from VW_INTRN,CO_CDTRN where INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and  IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"'  AND INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD and int_SBSCD1 in "+M_strSBSLS+" group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from VW_INTRN,CO_CDTRN where INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' and  IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"'  AND INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD and int_SBSCD1 in "+M_strSBSLS+" group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from VW_INTRN where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0')  and int_SBSCD1 in "+M_strSBSLS+" group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and IN_SBSCD1 in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' AND INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0')  and int_SBSCD1 in "+M_strSBSLS+" group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST,CO_CDTRN  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD1 in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD1 in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST,CO_CDTRN  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_STSFL not in ('X','0') and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD  and int_SBSCD1 in "+M_strSBSLS+"  group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL  not in ('X','0')  and int_SBSCD1 in "+M_strSBSLS+" group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			L_rstINMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINMTH!=null)
			{
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST  where  IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and IN_SBSCD in "+M_strSBSLS+" and INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0')  group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum((isnull(int_indqt,0)-isnull(int_fcmqt,0))) INDQT,sum(INT_RSNVL) RSNVL from MR_INTRN,MR_INMST  where  IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0')  and int_SBSCD1 in "+M_strSBSLS+"  group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) order by SUBSTRING(INT_PRDCD,1,4)";
			//System.out.println(M_strSQLQRY);
			L_rstINMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstINMTH!=null)
			{
			...
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,(isnull(int_indqt,0)-isnull(int_fcmqt,0)) INT_INDQT from MR_INTRN,MR_INMST,CO_CDTRN  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD in "+M_strSBSLS+" and INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) INT_INDQT,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST,CO_CDTRN  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD in "+M_strSBSLS+" and INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT,INT_FCMQT order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) INT_INDQT,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST,CO_CDTRN  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IN_ZONCD  and int_SBSCD1 in "+M_strSBSLS+"  group by INT_MKTTP,CMT_CHP02,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT,INT_FCMQT order by CMT_CHP02,SUBSTRING(INT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			//M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) int_indqt,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD in "+M_strSBSLS+" and IN_CMPCD=INT_CMPCD and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),(isnull(int_indqt,0)-isnull(int_fcmqt,0)) INT_INDQT order by SUBSTRING(INT_PRDCD,1,4)";
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) int_indqt,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP  not in ('04','05','12','16','21') and IN_SBSCD in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD in "+M_strSBSLS+" and IN_CMPCD=INT_CMPCD and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),int_indqt,INT_FCMQT order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) int_indqt,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST  where IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP ='04' AND INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and IN_CMPCD=INT_CMPCD and IN_MKTTP=INT_MKTTP and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0  and int_SBSCD1 in "+M_strSBSLS+"  group by INT_MKTTP,IN_SALTP,SUBSTRING(INT_PRDCD,1,4),int_indqt,INT_FCMQT order by SUBSTRING(INT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,(isnull(int_indqt,0)-isnull(int_fcmqt,0)) INT_INDQT from MR_INTRN,MR_INMST  where  IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and IN_SBSCD in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT order by SUBSTRING(INT_PRDCD,1,4)";
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) INT_INDQT,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST  where  IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and IN_SBSCD in "+M_strSBSLS+" and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_SBSCD in "+M_strSBSLS+" and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0 group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT,INT_FCMQT order by SUBSTRING(INT_PRDCD,1,4)";
			M_strSQLQRY="Select INT_MKTTP,SUBSTRING(INT_PRDCD,1,4) PRDCD,sum(isnull(INT_CFWQT,0)) CRFQT,sum((isnull(INT_RSNVL,0)/(isnull(int_indqt,0)-isnull(int_fcmqt,0)))*isnull(INT_CFWQT,0)) RSNVL ,isnull(int_indqt,0) INT_INDQT,isnull(int_fcmqt,0) INT_FCMQT from MR_INTRN,MR_INMST  where  IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_SALTP = '12' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' and IN_MKTTP=INT_MKTTP and IN_CMPCD=INT_CMPCD and IN_INDNO=INT_INDNO and IN_BKGDT < '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and INT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND INT_STSFL not in ('X','0') and isnull(INT_CFWQT,0)>0  and int_SBSCD1 in "+M_strSBSLS+"  group by INT_MKTTP,SUBSTRING(INT_PRDCD,1,4),INT_INDQT,INT_FCMQT order by SUBSTRING(INT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN,CO_CDTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD in "+M_strSBSLS+" and date(IVT_INVDT)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IVT_ZONCD group by IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(IVT_PRDCD,1,4)";
			M_strSQLQRY="Select IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN,CO_CDTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP ='04' and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IVT_ZONCD  and ivt_SBSCD1 in "+M_strSBSLS+" group by IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD in "+M_strSBSLS+" and date(IVT_INVDT)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP  ='04' and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D'  and ivt_SBSCD1 in "+M_strSBSLS+"  group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			L_rstIVDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVDAY!=null)
			{
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where  IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP = '12' and IVT_SBSCD in "+M_strSBSLS+" and date(IVT_INVDT)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D' group by IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			M_strSQLQRY="Select IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where  IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP = '12' and CONVERT(varchar,IVT_INVDT,101)='"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL = 'D'  and ivt_SBSCD1 in "+M_strSBSLS+"  group by IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			L_rstIVDAY=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVDAY!=null)
			{
			...
			M_strSQLQRY="Select IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN,CO_CDTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP ='04' and CONVERT(varchar,IVT_INVDT,101) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D' and CMT_CGMTP='SYS' and CMT_CGSTP='MR00ZON' and CMT_CODCD=IVT_ZONCD  and ivt_SBSCD1 in "+M_strSBSLS+"  group by IVT_MKTTP,CMT_CHP02,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by CMT_CHP02,SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP  not in ('04','05','12','16','21') and IVT_SBSCD in "+M_strSBSLS+" and date(IVT_INVDT) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D' group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			M_strSQLQRY="Select IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP ='04' and CONVERT(varchar,IVT_INVDT,101) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D'  and ivt_SBSCD1 in "+M_strSBSLS+"  group by IVT_MKTTP,IVT_SALTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			L_rstIVMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVMTH!=null)
			{
			...
			//OLD QUERY CHANGED BY VIJAY ON 24/02/2009
			//M_strSQLQRY="Select IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP = '12' and IVT_SBSCD in "+M_strSBSLS+" and date(IVT_INVDT) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D' group by IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			M_strSQLQRY="Select IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) PRDCD,sum(IVT_INVQT) INVQT,sum(IVT_RSNVL) RSNVL from MR_IVTRN  where IVT_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IVT_SALTP = '12' and CONVERT(varchar,IVT_INVDT,101) between '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtFMDAT.getText()))+"' and '"+M_fmtDBDAT.format(M_fmtLCDAT.parse(M_txtTODAT.getText()))+"' and IVT_STSFL ='D'  and ivt_SBSCD1 in "+M_strSBSLS+"  group by IVT_MKTTP,SUBSTRING(IVT_PRDCD,1,4) order by SUBSTRING(IVT_PRDCD,1,4)";
			System.out.println(M_strSQLQRY);
			L_rstIVMTH=cl_dat.exeSQLQRY0(M_strSQLQRY);
			if(L_rstIVMTH!=null)
			{
			...
			File L_filREPORT=new File(cl_dat.M_strREPSTR_pbst+"mr_rprs1."+(M_rdbTEXT.isSelected() ? "doc" : "htm"));
			FileOutputStream L_fosREPORT=new FileOutputStream(L_filREPORT);
			dosREPORT=new DataOutputStream(L_fosREPORT);
			//System.out.println("file created "+cl_dat.M_strREPSTR_pbst+"mr_rprs1."+(M_rdbTEXT.isSelected() ? "doc" : "htm"));
			...
			*/
			...
			{//DISPLAY HTML REPORT IN BROWSER
					...
					String L_strDOCFIL = cl_dat.M_strREPSTR_pbst+"mr_rprs1.doc";
					if(M_rdbHTML.isSelected())
					{
						L_strDOCEXE = "c:\\program files\\internet explorer\\iexplore.exe";
						L_strDOCFIL = cl_dat.M_strREPSTR_pbst+"mr_rprs1.htm";
					}
		...
		//PRINT TO PRINTER IN PRINT OPTION IN TEXT FORMAT
				...
				doPRINT(cl_dat.M_strREPSTR_pbst+"mr_rprs1.doc");
			...
			//E_MAIL THE RESPECTIVE FILE TO RECEIPENTS, ONE BY ONE
				for(int i=0;i<M_cmbDESTN.getItemCount();i++)
					((cl_eml)Class.forName("cl_eml").newInstance()).sendfile(M_cmbDESTN.getItemAt(i).toString(),cl_dat.M_strREPSTR_pbst+"mr_rprs1."+(M_rdbTEXT.isSelected() ? "doc" : "htm"),"Net Sales Realisation for the period from "+M_txtFMDAT.getText()+" to "+M_txtTODAT.getText(),"");
