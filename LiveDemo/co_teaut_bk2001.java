...
class co_teaut extends cl_pbase implements ChangeListener
{
	...
	private JPanel pnlGPAPR,pnlGPAUT,pnlINAUT,pnlCLSDT,pnlLTRCL;
	...
	co_teaut()
	{
       ...
       // Reclassification
    //    add(new JLabel("Product Type"),1,1,1,1,pnlLTRCL,'L');
	//  add(cmbPRDTP = new JComboBox(),2,1,1,1,pnlCLSDT,'L');
	//    add(txtLOTNO = new TxtLimit(8),2,2,1,0.75,pnlCLSDT,'L');
		...
		while(M_rstRSSET.next())
		{
		    ...
		    {
		        jtpTRNDT.add(pnlLTRCL,strLTRCL_fn);
		        intLTRCL = L_intTABCT;
		        // tblTSTVL.addMouseListener(this);
		        //((JTextField)tblTSTVL.cmpEDITR[TB_CMPVL]).addKeyListener(this);
		         L_intTABCT++;
		    }
		}
