...
class hr_teapr05 extends JFrame implements ActionListener,Runnable
{
   	private File file;
	...
	private static String M_strCMPCD ="05";
    hr_teapr05()
    {
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        hr_teapr05 ohr_teapr05 = new hr_teapr05();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        hr_teapr05_thrData thr1 = new hr_teapr05_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class hr_teapr05_thrData extends Thread
{
   // Hashtable hstData;
    String strDate="",M_strCMPCD="05";
    ...
    hr_teapr05_thrData(String strDate,Connection P_conSPDBA)
    {
