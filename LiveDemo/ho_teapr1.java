...
class ho_teapr1 extends JFrame implements ActionListener,Runnable
{
   	private File file;
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        ho_teapr1 oho_teapr1 = new ho_teapr1();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        ho_teapr1_thrData thr1 = new ho_teapr1_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class ho_teapr1_thrData extends Thread
{
   // Hashtable hstData;
    ...
    ho_teapr1_thrData(String strDate,Connection P_conSPDBA)
    {
    ...
    public void run()
    {
		 ...
		 String L_strACCRF="",L_strTRMID="",L_strEMPNO="",L_strPNCDT="",L_strPNCDTM="",L_strPNCDT1="",L_strPNCTM="",L_strPNCTM1="",L_strINOCD="";		 
		 ...
		 try
          {
         	...
         	stmSPDBA2 = conSPDBA.createStatement();
   			String L_strTMP = "Select distinct slt_cmpcd, ep_empno, ep_accrf, slt_pnctm, slt_inocd, slt_trmid, slt_stsfl from hr_sltrn1,hr_epmst where slt_cmpcd='02' and ep_cmpcd=slt_cmpcd and ep_sapno=slt_empcd and slt_stsfl='1'  order by slt_pnctm desc";
            ...
            if(L_rstRSSET !=null)
            {
                ...
                while((L_rstRSSET.next())&& L_flgRUN)
                {
                    ...
                    L_strINOCD = L_rstRSSET.getString("slt_inocd");
		   			L_STRQRY1 = "Select count(*) slt_count from ho_sltrn where slt_cmpcd='02' and slt_empno = '"+L_strEMPNO+"' and slt_pnctm='"+L_strPNCDTM+"' and slt_inocd='"+L_strINOCD+"'";
		            ...
		            L_rstRSSET2.close();
		            System.out.println("rs not null");
                    System.out.println("rs not null8");
				...
				L_STRSQL = "update hr_sltrn1 a set slt_stsfl='2' where slt_cmpcd='02' and slt_stsfl='1'";
				System.out.println(L_STRSQL);
