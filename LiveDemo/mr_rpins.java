...
class mr_rpins extends cl_rbase
{
			...
			prnHEADER();
				if(rdbPANCO.isSelected())
				{
					if(cmbRPTOP.getSelectedItem().toString().equals("Authorisation"))
					{
						...
						M_strSQLQRY = "select IN_INDNO,IN_BKGDT,PT_PRTNM ,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,INT_INDQT L_BALQT ";
					...
					if(cmbRPTOP.getSelectedItem().toString().equals("DO preparation"))
					{
						...
						M_strSQLQRY = "select IN_INDNO,IN_BKGDT,PT_PRTNM,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,(INT_INDQT-INT_DORQT) L_BALQT ";
						M_strSQLQRY += " from VW_INTRN,co_PTMST where";
						M_strSQLQRY +=" IN_BYRCD = PT_PRTCD and PT_PRTTP = 'C'";
						M_strSQLQRY +="and IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_BKGDT between '"+strFMDAT+"' and '"+strTODAT+"'";
					...
					if(cmbRPTOP.getSelectedItem().toString().equals("LA preparation"))
					{
						...
						M_strSQLQRY = "select IN_INDNO,IN_BKGDT,PT_PRTNM,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,(INT_INDQT-INT_LADQT) L_BALQT ";
						M_strSQLQRY += " from VW_INTRN,co_PTMST where";
						M_strSQLQRY +=" IN_BYRCD = PT_PRTCD and PT_PRTTP = 'C'";
						M_strSQLQRY +="and IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_BKGDT between '"+strFMDAT+"' and '"+strTODAT+"'";
					...
					if(cmbRPTOP.getSelectedItem().toString().equals("Dispatch"))
					{
						...
						M_strSQLQRY = "select IN_INDNO,IN_BKGDT,PT_PRTNM,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,(INT_INDQT-INT_INVQT) L_BALQT ";
						M_strSQLQRY += " from VW_INTRN, co_PTMST where";
						M_strSQLQRY +=" IN_BYRCD = PT_PRTCD and PT_PRTTP = 'C'";
						M_strSQLQRY +="and IN_CMPCD='"+cl_dat.M_strCMPCD_pbst+"' AND IN_BKGDT between '"+strFMDAT+"' and '"+strTODAT+"'";
						M_strSQLQRY +=" and INT_STSFL in ('1','2')";
				...
				if(rdbAMMND.isSelected())
				{
					...
					M_strSQLQRY = "select IN_INDNO,IN_AMDDT,PT_PRTNM ,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,INT_INDQT L_BALQT ";
					M_strSQLQRY += " from VW_INTRN,co_PTMST where ";
					M_strSQLQRY +=" IN_BYRCD = PT_PRTCD and PT_PRTTP = 'C'";
				...
				if(rdbCANCL.isSelected())
				{
					...
					M_strSQLQRY = "select IN_INDNO,IN_LUPDT,PT_PRTNM ,INT_PRDDS,(ifnull(int_indqt,0)-ifnull(int_fcmqt,0)) INT_INDQT,INT_INDQT L_BALQT ";
					M_strSQLQRY += " from VW_INTRN,co_PTMST where ";
					M_strSQLQRY +=" IN_BYRCD = PT_PRTCD and PT_PRTTP = 'C'";
