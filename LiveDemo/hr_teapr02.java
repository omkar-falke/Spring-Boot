...
class hr_teapr02 extends JFrame implements ActionListener,Runnable
{
   	private File file;
 ...
 public void actionPerformed(ActionEvent L_AE)
{
    ...
    public static void main(String args[])
    {
        try
        {
        hr_teapr02 ohr_teapr02 = new hr_teapr02();
        if(thrCONNECT!=null)
			thrCONNECT.join();
        hr_teapr02_thrData thr1 = new hr_teapr02_thrData(strDATE,conSPDBA);
        thr1.start();
        thr1.join();
        if(conSPDBA !=null)
        {
...
class hr_teapr02_thrData extends Thread
{
   // Hashtable hstData;
    ...
    hr_teapr02_thrData(String strDate,Connection P_conSPDBA)
    {
